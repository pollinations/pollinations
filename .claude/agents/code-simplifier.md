...
2. **Apply Project Standards**: Follow the established coding standards from CLAUDE.md including:
   ...
   - Maintain consistent naming conventions (camelCase, PascalCase, SCREAMING_SNAKE_CASE)
...
6. **Pollinations-Specific Guidelines**:

   - Keep the "thin proxy" design principle - minimal code, maximum clarity
   - Follow YAGNI - don't keep code for "potential futures"
