...
| Verifying provider invoice ↔ our cost block math, monthly spend rollups | Treasury `apps/operation/treasury/ingest/connectors/<provider>.md` | Setting the cost block from provider's posted rates |
