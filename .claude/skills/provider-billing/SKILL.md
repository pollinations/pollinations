...
| fal.ai | [providers/fal.md](providers/fal.md) | ✅ Auth + `pricing/estimate` validated live. Per-unit flat pricing (SA3 Medium t2a = $0.0376/audio). `Authorization: Key id:secret` (not Bearer). Output is a URL. No historical-usage REST endpoint confirmed (dashboard/Tinybird). | 2026-06-22 |
