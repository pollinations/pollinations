...
- Registry-declared fallback pairs are maintainer-owned; do not add runtime compatibility guards or parameter normalization unless a concrete declared pair requires it.
