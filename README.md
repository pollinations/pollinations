...
|------|-------------|--------|
| [Ai.logise](https://ailogise.xyz/) | Fast AI chat + image generator with filtering; fixing a greeting filter bug. | @dereszewski |
| [https://myceli.ai/](https://myceli.ai/) | AI platform for building, deploying, and managing intelligent agents. | @ElliotEtag |
