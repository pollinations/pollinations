...
|------|-------------|--------|
| [AI homework solver](https://the-lazybone.github.io/ONLUYEN-HOMEWORK-AUTO-SOLVER/wrapper.user.js) | Browser-based automation tool that solves MCQ, short answers, true/false, blanks | @The-Lazybone |
