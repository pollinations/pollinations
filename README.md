...
|------|-------------|--------|
| [M Assistant](https://routinehub.co/shortcut/18709/) | Provide conversational AI support for scheduling, information retrieval, and simple task automation across apps and devices. | @morriszdweck |
