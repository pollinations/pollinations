...
|------|-------------|--------|
| [Forge of Artifacts](https://si-log-gaelah.github.io/Forge-of-Artifacts/) | AI blacksmith crafting unique fantasy artifacts for tabletop RPG DMs and devs. | @si-log-gaelah |
