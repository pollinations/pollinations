...
|------|-------------|--------|
| [SmartInfiniteYield](https://github.com/BokX1/InfiniteYieldWithAI/blob/main/README.md) | _SmartInfiniteYield_ is a next-generation Roblox admin script wrapper that acts | @BokX1 |
