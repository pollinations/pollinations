...
- **2026-08-06** – **🌟 The app garden got roots** The community directory now runs on a validated, newest-first catalog, so [browse 763 community apps](https://pollinations.ai/apps) without relying on a heroic Markdown file.
