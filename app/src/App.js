    ...
    <>
      ...
      <Container maxWidth="lg">
        <Routes>
          ...
          <Route
            exact
            path={ROUTES.myPollens.to}
            element={<LocalPollens node={node} />}
          />
          ...
          <Route
            path="n/:nodeID"
            element={
              <NodeWithData node={node} overrideNodeID={overrideNodeID} />
            }
          />
          <Route
            path="p/:contentID/*"
...
const ModelRoutes = ({ node, navigateToNode, overrideContentID }) => {
  ...
  return (
    <Routes>
      ...
      <Route
        path="create"
        element={<Creator ipfs={ipfs} node={node} dispatch={dispatch} />}
      />
    </Routes>
  );
};
