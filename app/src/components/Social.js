...
export const SocialPostStatus = ({ results }) => Object.keys(results).map((platform) => results[platform] && PostResultLink(results[platform], platform));
...
function PostResultLink({
  status, message, errors, postIds, errorMessage,
}, platform) {
