...
export default function Home() {
    ...
    return  <>
                <Container maxWidth="md">
                  ...
                  <ListItem>- A frontend hosting a set of <Link href="https://github.com/pollinations/hive" target="_blank">curated models</Link> that allow creating and experimenting with generative art (this page).</ListItem>
