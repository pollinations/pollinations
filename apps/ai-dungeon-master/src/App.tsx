...
export default function App() {
    ...
    const fetchStory = async (prompt: string): Promise<string> => {
        ...
        try {
            const systemPrompt =
                "You are a creative dungeon master for a fantasy RPG. Write a short, immersive scene description in 2-3 sentences. Focus only on the immediate environment and atmosphere.";
                    ...
                    messages: [
                        {
                            role: "system",
                            content:
                                "You are a fantasy RPG enemy generator. Respond only with valid JSON.",
                        },
                    ...
                    messages: [
                        {
                            role: "system",
                            content:
                                "You are a fantasy RPG item generator. Respond only with valid JSON arrays.",
                        },
