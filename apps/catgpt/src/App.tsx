...
function setUrlPrompt(prompt: string, model: string): void {
...
export function App() {
    ...
    const [activeModel, setActiveModel] = useState(
        () => localStorage.getItem(MODEL_STORAGE_KEY) || FALLBACK_MODEL,
    );
    ...
    async function generateMeme() {
        ...
        setUrlPrompt(question, activeModel);
        ...
        try {
            ...
            const response = await client.image(imagePrompt, {
                model: activeModel,
                width: 1024,
                height: 1024,
