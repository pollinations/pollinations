...
const BYOPModal = ({ isOpen, onClose }) => {
    ...
    const handleSave = () => {
        ...
        if (window?.showToast) {
            window.showToast(
                trimmed ? "API key saved" : "API key cleared",
                "success",
            );
        }
        onClose();
            ...
            <div className="themes-modal-content">
                ...
                <div className="themes-modal-body">
                    <p className="byop-desc">
                        Paste a Pollinations API key (<code>sk_…</code>) to use
                        your own Pollen balance for requests. The key is stored
                        only in this browser.
                    </p>

                    <label className="byop-label" htmlFor="byop-key-input">
                        API key
                    </label>
                    <input
                        id="byop-key-input"
                    ...
                    <div className="byop-actions">
                        {hasExistingKey && (
                            <button
                                className="byop-btn byop-btn-ghost"
                        ...
                        <button
                            className="byop-btn byop-btn-primary"
                            onClick={handleSave}
                            type="button"
                        >
                            Save
