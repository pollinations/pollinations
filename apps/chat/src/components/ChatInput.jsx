...
const ChatInput = ({
    ...
    const handleSend = () => {
        ...
        if ((!trimmed && !selectedAttachment) || isListening || isGenerating)
            return;
        ...
        setInputValue("");
        if (selectedAttachment && fileInputRef.current)
