            ...
            <div
                ...
                style={{
                    clipPath: highlightRect
                        ? generateClipPath(highlightRect)
                        : "none",
                }}
                aria-hidden="true"
            />
...
const TutorialStepIcon = memo(({ icon, animate }) => {
    return (
        <div className={`tutorial-step-icon ${animate ? "animate" : ""}`}>
            <span
                className="tutorial-step-icon-content"
                role="img"
                aria-hidden="true"
            >
                {icon}
...
const TutorialProgressDots = memo(
    ({ currentStep, totalSteps, onDotClick, disabled }) => {
        return (
            <div
    ...
    return (
        <div className="tutorial-shortcuts-box">
            <div className="tutorial-shortcuts-header">
                ...
                <span className="tutorial-shortcuts-label">
                    Keyboard Shortcuts
                </span>
            </div>
            <div className="tutorial-shortcuts-list">
                {shortcuts.map((shortcut, index) => (
                    <div key={index} className="tutorial-shortcut-row">
                            ...
                            {shortcut.keys.map((key, keyIndex) => (
                                <React.Fragment key={keyIndex}>
                                    ...
                                    {keyIndex < shortcut.keys.length - 1 && (
                                        <span className="tutorial-key-separator">
                                            +
                                        </span>
                                    )}
                                </React.Fragment>
                        ...
                        <span className="tutorial-shortcut-action">
                            {shortcut.action}
                        </span>
                    </div>
                ))}
...
const TutorialActions = memo(
    ({ isFirstStep, isLastStep, onPrev, onNext, onSkip, disabled }) => {
        return (
