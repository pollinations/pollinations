...
const DEFAULT_TUTORIAL_STEPS = [
    {
        ...
        content:
            "Your all-in-one AI creative studio. Chat with advanced language models, generate stunning images, create videos, and write code—all in one seamless interface. Let's take a quick tour to help you get started!",
        target: null,
        position: "center",
        icon: "🌸",
    },
    {
        ...
        content:
            "Click here to switch between different AI models. Each model has unique strengths—some excel at creative writing, others at coding or analytical tasks. Experiment to find the perfect fit for your needs.",
        target: ".model-chip",
        position: "bottom",
        icon: "🧠",
    },
    {
        ...
        content:
            "The plus button opens your creative toolkit. Upload images for analysis, attach documents for context, or access special features like the code canvas. Your files integrate seamlessly into the conversation.",
    ...
    },
    {
        ...
        content:
            "Transform your ideas into stunning visuals! Simply type /imagine followed by your description, and watch as AI brings your vision to life. Be descriptive for best results.",
        target: "#messageInput",
        position: "top",
        icon: "🎨",
        example:
            "/imagine a serene Japanese garden at sunset with cherry blossoms",
    },
    {
        title: "Create AI Videos",
        content:
            "Bring your stories to motion! Use /video with a descriptive prompt to generate short AI videos. Perfect for visualizing concepts, creating content, or just having fun.",
        target: "#messageInput",
        position: "top",
        icon: "🎬",
    ...
    },
    {
        ...
        content:
            "Boost your productivity with these handy shortcuts. Power users love these time-savers! You're all set to start creating. Have fun exploring!",
        target: null,
        position: "center",
        icon: "⚡",
        shortcuts: [
