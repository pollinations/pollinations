...
const MarkdownDocumentPage = ({
    ...
    useEffect(() => {
        ...
        fetch(source)
            ...
            .catch((err) => {
                console.error(`Error fetching ${errorLogLabel}:`, err);
                setError(err.message);
                setLoading(false);
            });
    }, [documentTitle, errorLogLabel, fetchErrorMessage, source]);

    if (loading) {
        return (
            <Box sx={pageStateStyles}>
                    ...
                    >
                        <Paper
                            sx={{
                                ...
                                borderRadius: 3,
                                p: { xs: 3, md: 6 },
                                "& .markdown-content": markdownStyles,
                            }}
                        >
