    ...
    server.registerTool(
        "jev_decide",
        {
            description:
                ...
                "Send multiple named questions in one call. For choice, criteria keys are the options; " +
                "include option-specific guidance in instructions, since criteria descriptions are not forwarded.",
