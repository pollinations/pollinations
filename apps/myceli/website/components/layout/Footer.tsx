          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <p className="text-gray-600 font-medium">
                © {new Date().getFullYear()} Myceli.ai OÜ. All rights reserved.
              </p>
              ...
              <p className="flex items-center">
                <span className="inline-block w-1.5 h-1.5 bg-blue-400 rounded-full mr-2 animate-pulse" style={{animationDelay: '0.5s'}}></span>
                Tallinn, Estonia 🇪🇪
              </p>
            </div>
          </div>
          ...
          >
            <span className="flex items-center">
              {copied ? (
                ...
                <>
                  <svg className="w-4 h-4 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
