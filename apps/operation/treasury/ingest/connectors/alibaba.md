...
- June 2026 returned one CLI meter row, source `cli`, currency `USD`, paid total `606.70`.
...
- `op_cloud_type`: `infrastructure` unless the product rows clearly indicate inference/model spend
