        ...
        <div className="min-h-screen bg-gradient-to-b from-amber-100/50 via-orange-50/30 to-rose-50/40">
            ...
            <section className="relative min-h-[90vh] flex flex-col justify-center py-24 md:py-32 lg:py-40">
                ...
                <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-4xl text-center relative z-10">
                    ...
                    <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                        We are the company behind{" "}
                        <strong className="text-gray-800">
                            pollinations.ai
                        </strong>
                        , a unified AI platform and ecosystem powered by Pollen
                        — a simple, universal credit that developers and
                        end-users use across apps.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        >
                            <span className="mr-2">→</span> Request Investor
                            Access
                        </a>
                        <a
            ...
            <section className="py-20 md:py-28 bg-white/60">
                <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-3xl">
                    ...
                    <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                        <p>
                            <strong className="text-gray-800">Myceli</strong> is
                            the holding company and product studio behind the{" "}
                            <em>pollinations.ai</em> ecosystem.
                        </p>
                        <p>
                            <em>pollinations.ai</em> began as an open-source
                            creative AI project. Over time, the community and
                            code outgrew the original structure. Myceli was
                            created to give <em>pollinations.ai</em> a proper
                            foundation, a clear business model, and the
                            resources to scale.
                        </p>
                        <p>
                            We build developer-centric AI infrastructure with a
                            soft, expressive identity — tools designed for
                            creativity, experimentation, and scalable app
                            ecosystems.
                        </p>
                        <p>
                            Our mission is to grow an open, community-driven
                            environment where developers create the next
                            generation of AI-native apps, and where Pollen
                            becomes the shared economic layer underneath them.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-28">
                <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-3xl">
                    ...
                    <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                        <p>
                            <em className="text-gray-800 not-italic font-semibold">
                                pollinations.ai
                            </em>{" "}
                            is our flagship product — an AI platform for
                            creative developers.
                        </p>
                        <p className="font-medium text-gray-700">
                            <em>pollinations.ai</em> provides:
                        </p>
                        <ul className="space-y-3 ml-1">
                            <li className="flex items-start">
                                <span className="inline-block w-2 h-2 bg-orange-400 rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                                <span>
                                    A unified multimodal API (image, text,
                                    audio; real-time and video soon)
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="inline-block w-2 h-2 bg-orange-400 rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                                <span>
                                    ...
                                    , a single credit for all generative media
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="inline-block w-2 h-2 bg-orange-400 rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                                <span>
                                    Developer tiers, grants, and rewards
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="inline-block w-2 h-2 bg-orange-400 rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                                <span>
                                    <em>pollinations.ai</em> Login (OAuth) for
                                    instant app onboarding
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="inline-block w-2 h-2 bg-orange-400 rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                                <span>
                                    A growing community building games, tools,
                                    worlds, and workflows
                                </span>
                            </li>
                        </ul>
                        <p>
                            <em>pollinations.ai</em> is both a playground and a
                            platform: developers explore, build, launch apps —
                            and those apps plug into a shared economy.
                        </p>
                    </div>
            ...
            <section className="py-20 md:py-28 bg-gradient-to-b from-amber-50/40 to-white">
                <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-3xl">
                    ...
                    <p className="text-lg text-gray-600 mb-10 text-center">
                        The foundation of Myceli&apos;s business is the{" "}
                        <strong className="text-gray-800">
                            Pollen economy
                        </strong>
                        .
                    ...
                    <ol className="space-y-4 text-lg text-gray-600 mb-10">
                        <li className="flex items-start">
                            <span className="inline-flex items-center justify-center w-7 h-7 bg-orange-100 text-orange-600 font-semibold rounded-full mr-4 flex-shrink-0 text-sm">
                                1
                            </span>
                            <span>
                                <strong className="text-gray-800">
                        ...
                        <li className="flex items-start">
                            ...
                            <span>
                                ...
                                with <em>pollinations.ai</em> Login (OAuth).
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="inline-flex items-center justify-center w-7 h-7 bg-orange-100 text-orange-600 font-semibold rounded-full mr-4 flex-shrink-0 text-sm">
                            ...
                            <span>
                                <strong className="text-gray-800">
                                    Users buy Pollen inside those apps
                                </strong>{" "}
                                with one click.
                            </span>
                        </li>
                        ...
                        <li className="flex items-start">
                            ...
                            <span>
                                The economy strengthens as more apps appear.
                            </span>
                        </li>
                    </ol>
                    ...
                    <div className="bg-white/80 rounded-2xl p-8 shadow-sm border border-orange-100">
                        ...
                        <ul className="space-y-3 text-gray-600">
                            ...
                            <li className="flex items-start">
                                <span className="inline-block w-2 h-2 bg-amber-400 rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                                <span>
                                    A single credit shared across all
                                    experiences
                                </span>
                            </li>
                            <li className="flex items-start">
                            ...
                            <li className="flex items-start">
                                <span className="inline-block w-2 h-2 bg-amber-400 rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                                <span>
                                    Aligned incentives for developers and Myceli
                                </span>
                            </li>
                        </ul>
                        <p className="text-gray-600 mt-6">
                            API usage and direct developer purchases exist, but
                            the{" "}
                            <strong className="text-gray-800">
                                core engine
                            </strong>{" "}
                            is consumer Pollen purchases inside
            ...
            <section className="py-20 md:py-28">
                <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-3xl">
                    ...
                    <p className="text-lg md:text-xl text-gray-700 font-medium text-center mb-12 leading-relaxed">
                        Builders attract users → users buy Pollen → developers
                        earn → more builders join → more apps → more users →
                        more Pollen circulation.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            ...
                            {
                                num: 2,
                                text: "They build apps with pollinations.ai",
                            },
                            {
                                num: 3,
                                text: "Users log in with pollinations.ai",
                            },
                            { num: 4, text: "Users buy Pollen inside apps" },
                            { num: 5, text: "Developers earn rewards" },
                            {
                                num: 6,
                                text: "More apps, more users, more spending",
                            },
                    ...
                    <p className="text-lg text-gray-600 text-center mt-10">
                        This is how Pollen becomes a widely recognized way to
                        buy generative AI.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 md:py-28 bg-gradient-to-b from-white to-amber-50/30">
                <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-3xl">
                    ...
                    <p className="text-lg text-gray-600 mb-10 text-center">
                        The next chapters of the <em>pollinations.ai</em>{" "}
                        ecosystem, managed by Myceli:
                    </p>
                    ...
                    <div className="space-y-4">
                        {[
                            {
                                id: "in-app-purchases",
                                title: "In-app Pollen purchases",
                                desc: "(primary economic unlock)",
                            },
                            {
                                id: "app-hosting",
                                title: "App hosting & discovery",
                                desc: "(launch and showcase apps easily)",
                            },
                            {
                                id: "quests",
                                title: "Quests, bounties & community programs",
                                desc: "",
                            },
                            {
                                id: "sdk-templates",
                                title: "SDK upgrades & templates",
                                desc: "for fast app creation",
                            },
                        ].map(({ id, title, desc }) => (
                            <div
                                key={id}
                    ...
                    <p className="text-lg text-gray-600 text-center mt-10">
                        These steps transform <em>pollinations.ai</em> into a
                        full AI app development ecosystem.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
                        <div className="p-6 bg-white/60 rounded-xl border border-gray-100">
                            ...
                            <p className="text-sm text-gray-600 mb-3">
                                Founder of pollinations.ai, with years of
                                experience in generative AI and creative
                                tooling.
                            </p>
                            <a
                                href="mailto:thomas@myceli.ai"
                        ...
                        <div className="p-6 bg-white/60 rounded-xl border border-gray-100">
                            ...
                            <p className="text-sm text-gray-600 mb-3">
                                6+ years in AI infrastructure development. Leads
                                operations, partnerships, and business strategy.
                            </p>
                            <a
                                href="mailto:elliot@myceli.ai"
                                className="text-sm text-orange-600 hover:text-orange-700 transition-colors"
                            >
                                elliot@myceli.ai
                            </a>
            ...
            <section className="py-24 md:py-32">
                <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-3xl text-center">
                    ...
                    <p className="text-lg text-gray-600 mb-10">
                        Access the data room, financials, roadmap details, and
