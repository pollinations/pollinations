...
class GitHubPRManager:
    ...
    async def review_pr(
        ...
        """
        from polly_core.tools._registry import get_config
        from polly_core.client import PollyClient
        pollinations_client = PollyClient(get_config())
...
# =============================================================================
# STRIPPED PR TOOL HANDLER - Read-only + comment + AI review
# =============================================================================
...
async def tool_github_pr(
    ...
    **kwargs,
    ...
    if action == "get":
        ...
        return await github_pr_manager.add_comment(pr_number, comment, "Polly API")

    elif action == "review":
        if not pr_number:
            return {"error": "pr_number required"}
        return await github_pr_manager.review_pr(
            pr_number, post_to_github=False, author="Polly API"
        )
        ...
        return {
            ...
            "valid_actions": [
                "get", "list", "get_files", "get_diff", "get_checks",
                "get_commits", "get_threads", "get_review_comments",
                "get_file_at_ref", "get_history", "comment", "review",
            ],
        }
