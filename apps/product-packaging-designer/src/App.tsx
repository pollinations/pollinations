...
function App() {
    ...
    const generatePackaging = async () => {
        ...
        if (file && file.size > MAX_FILE_SIZE) {
            alert(
                `Image too large! Please use an image under ${MAX_FILE_SIZE / (1024 * 1024)}MB.`,
            );
            return;
        }
            ...
            <div className="relative container mx-auto px-4 py-8 max-w-7xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
                    <div className="space-y-2">
                        ...
                        <p
                            className={`text-lg ml-16 ${isDark ? "text-gray-300" : "text-gray-600"}`}
                        >
                            Transform products into professional packaging
                            mockups
                        </p>
                    </div>
                    <button
                    ...
                    >
                        ...
                        >
                            {isGenerating ? (
                                ...
                                <div
                                    className={`w-full space-y-4 ${imageLoaded ? "animate-fadeIn" : ""}`}
                                >
                                ...
                                <div className="text-center space-y-4">
                                    ...
                                    <p
                                        className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}
                                    >
                                        Upload an image and click Generate to
                                        start creating
                                    </p>
                                </div>
                            )}
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            >
                                ...
                                <div
                                    className={`p-4 border-t ${isDark ? "border-gray-600/50" : "border-gray-200"}`}
                                >
                                    <button
                                        onClick={() => {
