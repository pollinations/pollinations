...
export default function Index() {
    ...
    return (
        <>
            {/* Floor background with animations behind everything */}
            <FloorBackground
                currentFloor={gameState.currentFloor}
                animationMode={settingsLoaded ? animationMode : "lottie"}
            />

            {/* Game UI */}
            <div className="flex flex-col items-center justify-center h-screen overflow-hidden bg-transparent text-green-400 p-4 font-mono relative z-10">
                <Card className="w-full max-w-2xl max-h-[90vh] p-6 space-y-6 bg-gray-900/90 border-green-400 border-2 rounded-none overflow-hidden flex flex-col">
                    <div className="text-center space-y-4">
                        ...
                        {messages.length > 0 && (
                            <div className="text-sm text-yellow-400">
                                Charge Remaining: <b>{gameState.movesLeft}</b>{" "}
                        ...
                        gameState.firstStageComplete && (
                            <div className="bg-green-900 text-green-200 p-4 rounded-lg flex items-center space-x-2">
                                ...
                                <p>
                                    ...
                                    successfully navigated the neurotic elevator
                                    to the ground floor.
                                    <br />
                                    <br />
                                    Now, brace yourself for the next challenge:{" "}
                                    <em>Marvin the Paranoid Android</em> awaits.
                                    <br />
                                    <br />
                                    <Button
                        ...
                        <>
                            ...
                            {gameState.hasWon && (
                                <div className="space-y-4">
                                    <div className="bg-green-900 text-green-200 p-4 rounded-lg text-center animate-bounce">
                                        ...
                                        <p>
                                            You've successfully convinced Marvin
                                            to join you and reached the top
                                            floor together. Even if Marvin
                                            thinks it was all pointless, you've
                            ...
                            {!gameState.hasWon && gameState.movesLeft <= 0 && (
                                <div className="bg-red-900 text-red-200 p-4 rounded-lg text-center animate-bounce">
                                    ...
                                    <p>
                                        You've run out of moves. Time to consult
                                        your copy of the Hitchhiker's Guide to
                                        the Galaxy!
                                    </p>
                                </div>
                            )}
                ...
                <div className="text-center text-green-400 mt-4 text-xs max-w-xl space-y-2">
                    {/* Animation Toggle - Centered */}
                    {settingsLoaded && (
                    ...
                    <p>
                        This journey is brought to you by the{" "}
                        <a href="https://websim.ai/c/FAflFDzXEC1ABzFvz">
                            Sirius Cybernetics Corporation
                        </a>
                        . For more galactic adventures, visit{" "}
                        <a
