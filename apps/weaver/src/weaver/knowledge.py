...
from weaver.registry import get_model_catalog, get_voices

# Curated guidance, grounded in the live lineup (2026-07-10). Maintain this by hand.
BEST_AT: dict[str, str] = {
    # Image
    "black-forest-labs/FLUX.1-schnell": "fast general-purpose image, good default",
    "ideogram-ai/ideogram-v4-quality": "best text/typography in images (posters, labels, signs)",
    "openai/gpt-image-1.5": "strong text rendering, photoreal, instruction-following",
    "google/gemini-2.5-flash-image": "best image editing / image-to-image, text-in-image",
    "google/gemini-3-pro-image": "highest-quality image editing",
    "black-forest-labs/flux.1-kontext-pro": "precise image editing from a reference image",
    "PrunaAI/p-image-Edit": "image editing",
    "bytedance-seed/seedream-4.5": "high-quality photoreal / artistic generation",
    "qwen/qwen-image": "solid general image, multilingual prompts",
    # Video
    "alibaba/wan-2.6": "text-to-video and start/end-frame animation",
    "wan-video/wan-2.2-fast": "faster video, start/end-frame",
    "bytedance/seedance-1-pro-fast": "high-quality cinematic video",
    "google/veo-3.1-fast": "premium video quality",
    "x-ai/grok-imagine-video": "video generation",
    # Audio (TTS)
    "openai/gpt-audio-mini": "default TTS, natural voices, verbatim narration",
    "openai/gpt-audio-1.5": "highest-quality TTS",
    "elevenlabs/eleven-v3": "expressive multilingual TTS",
    "elevenlabs/eleven-text-to-sound-v2": "sound effects",
    "elevenlabs/music-v2": "music generation",
    # Transcription
    "google/gemini-3.6-flash": "audio transcription (input_audio), multimodal understanding",
    "openai/whisper-large-v3": "speech-to-text",
    "elevenlabs/scribe-v2": "speech-to-text",
    # Text / brain
    "z-ai/glm-5.2": "agent brain (tool-calling)",
    "gemini-search": "web search with live results",
    "openai/gpt-5.5": "strong general reasoning/writing",
    "anthropic/claude-opus-5": "strong writing and reasoning",
}
