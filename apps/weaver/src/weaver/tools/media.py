...
from weaver.config import settings  # noqa: F401  (patched in tests)
from weaver.tools.gen import _fetch_bytes, _http_client, _key
from weaver.tools.shell import _workdir
