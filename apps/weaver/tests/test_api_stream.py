...
from weaver import api as api_mod
...
def _no_network(monkeypatch):
    ...
    monkeypatch.setattr("weaver.registry.warm_registry", noop)
...
def test_any_bearer_is_spendable(monkeypatch):
    ...
    from weaver.config import _current_api_key
