...
```bash
scp community-monitor/CYCLE.md community-monitor:/home/ubuntu/monitor/CYCLE.md
```
...
```bash
scp community-monitor/watchdog.sh community-monitor:/home/ubuntu/monitor/watchdog.sh
