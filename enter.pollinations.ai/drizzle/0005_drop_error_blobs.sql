-- Migration: Drop error_stack and error_details columns to reduce D1 memory usage
-- These large TEXT columns were causing SQLITE_NOMEM errors under high load
-- Error details are still logged but no longer stored in the database
