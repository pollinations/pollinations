...
CREATE TABLE `__new_event` (
	...
	`token_price_prompt_text` real DEFAULT 0 NOT NULL,
	`token_price_prompt_cached` real DEFAULT 0 NOT NULL,
	`token_price_prompt_audio` real DEFAULT 0 NOT NULL,
	`token_price_prompt_image` real DEFAULT 0 NOT NULL,
	`token_price_completion_text` real DEFAULT 0 NOT NULL,
	`token_price_completion_reasoning` real DEFAULT 0 NOT NULL,
	`token_price_completion_audio` real DEFAULT 0 NOT NULL,
	`token_price_completion_image` real DEFAULT 0 NOT NULL,
	`token_price_completion_video_seconds` real DEFAULT 0 NOT NULL,
	`token_price_completion_video_tokens` real DEFAULT 0 NOT NULL,
	`token_count_prompt_text` integer DEFAULT 0 NOT NULL,
	`token_count_prompt_audio` integer DEFAULT 0 NOT NULL,
	`token_count_prompt_cached` integer DEFAULT 0 NOT NULL,
	`token_count_prompt_image` integer DEFAULT 0 NOT NULL,
	`token_count_completion_text` integer DEFAULT 0 NOT NULL,
	`token_count_completion_reasoning` integer DEFAULT 0 NOT NULL,
	`token_count_completion_audio` integer DEFAULT 0 NOT NULL,
	`token_count_completion_image` integer DEFAULT 0 NOT NULL,
...
CREATE INDEX `idx_event_status_created` ON `event` (`event_status`,`created_at`);--> statement-breakpoint
