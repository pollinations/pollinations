-- Promote the 159 canonical model IDs renamed by this release in stored
-- API-key allowlists. Earlier compatibility migrations canonicalized known
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'flux-2-pro'
                            THEN 'black-forest-labs/flux.2-pro'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"flux-2-pro"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'flux-2-pro'
    )
END;
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'flux-2-flex'
                            THEN 'black-forest-labs/flux.2-flex'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"flux-2-flex"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'flux-2-flex'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'dreamshaper'
                            THEN 'lykon/dreamshaper-8-lcm'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"dreamshaper"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'dreamshaper'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'eleven-dialogue'
                            THEN 'elevenlabs/eleven-v3:dialogue'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"eleven-dialogue"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'eleven-dialogue'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'eleven-voice-changer'
                            THEN 'elevenlabs/eleven-multilingual-sts-v2'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"eleven-voice-changer"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'eleven-voice-changer'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'eleven-voice-isolator'
                            THEN 'elevenlabs/voice-isolator'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"eleven-voice-isolator"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'eleven-voice-isolator'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'gemini-search'
                            THEN 'google/gemini-2.5-flash-lite:search'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"gemini-search"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'gemini-search'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'grok'
                            THEN 'x-ai/grok-4.20'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
...
WHERE CASE
    WHEN instr(permissions, '"grok"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'grok'
    )
END;
UPDATE apikey
SET permissions = json_set(
...
WHERE CASE
    WHEN instr(permissions, '"grok-transcribe"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'grok-transcribe'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'hyper3d-rodin'
                            THEN 'hyper3d/rodin-2.5'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"hyper3d-rodin"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'hyper3d-rodin'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'midijourney'
                            THEN 'pollinations/midijourney'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"midijourney"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'midijourney'
    )
END;
UPDATE apikey
SET permissions = json_set(
                ...
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'midijourney-large'
                            THEN 'pollinations/midijourney-large'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'perplexity-fast'
                            THEN 'perplexity/sonar'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"perplexity-fast"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'perplexity-fast'
    )
END;
UPDATE apikey
SET permissions = json_set(
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'scribe-realtime'
                            THEN 'elevenlabs/scribe-v2-realtime'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"scribe-realtime"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'scribe-realtime'
    )
END;
UPDATE apikey
SET permissions = json_set(
                ...
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'stable-audio-3-large'
                            THEN 'stability-ai/stable-audio-3'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
                ...
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'stable-audio-3-medium'
                            THEN 'stability-ai/stable-audio-3-medium'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
    ...
    (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'trellis-2'
                            THEN 'microsoft/trellis-2'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
...
WHERE CASE
    WHEN instr(permissions, '"trellis-2"') = 0 THEN 0
    WHEN NOT json_valid(permissions) THEN 0
    WHEN json_type(permissions, '$.models') != 'array' THEN 0
    ELSE EXISTS (
        SELECT 1
        FROM json_each(permissions, '$.models') AS model
        WHERE model.type = 'text' AND model.value = 'trellis-2'
    )
END;
UPDATE apikey
SET permissions = json_set(
                ...
                SELECT
                    CASE
                        WHEN model.type = 'text' AND model.value = 'wan-image-pro'
                            THEN 'alibaba/wan-2.7-image-pro'
                        ELSE model.value
                    END AS model_id,
                    CAST(model.key AS integer) AS position
                FROM json_each(apikey.permissions, '$.models') AS model
