                    ...
                    >
                        ...
                        {endpoint?.pending && (
                            <Alert intent="info" title="Changes queued">
                                This form shows the queued values. They take
                                effect{" "}
                                {new Date(
                        ...
                        {form.visibility === "public" && (
                            <Alert
                                intent="warning"
                                title="Public provider duties"
                            >
                                Requests are sent to your endpoint. You are
                                responsible for securing caller data and
                                disclosing how you retain, share, train on, or
                                otherwise use it.
                            </Alert>
                        )}
