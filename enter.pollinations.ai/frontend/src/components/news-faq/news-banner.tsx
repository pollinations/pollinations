...
const PINNED_NEWS: Highlight[] = [
    ...
    },
    {
        ...
        emoji: "🎯",
        title: "Hourly Pollen refill is ending",
        description: "User tiers are going away; balance buckets remain.",
        details: [
            "The automatic hourly Pollen refill stops on June 22.",
            "Existing Tier balance remains spendable and still pays before Paid balance.",
            "Pollen quests continue to pay into Paid balance.",
