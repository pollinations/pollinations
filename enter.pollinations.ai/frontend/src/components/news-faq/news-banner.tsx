...
const PINNED_NEWS: Highlight[] = [
    {
        ...
        details: [
            ...
            "Redirects to a cheaper model: Sonar Pro and Sonar Reasoning Pro → Sonar, without reasoning (Sep 27). Nova Canvas → GPT Image 1 Mini, which ignores seeds (Sep 30). Qwen3 TTS Instruct → Qwen3 TTS Flash, without the instructions parameter (Oct 9).",
