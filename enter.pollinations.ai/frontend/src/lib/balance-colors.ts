 ...
 * and paid/reward chips read as the same visual identity. Hover is handled
...
export const REWARD_COLOR = "oklch(0.93 0.06 55)"; // matches --color-tier-pale (light peach — same as reward chip bg)
