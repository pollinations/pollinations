...
// Generated by Wrangler by running `wrangler types --env-file /var/folders/nk/48zb93yj5kj0rwrdg4t3qsj40000gn/T/.sops1180840485/tmp-file3777775773 --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: 2810cb0d8aaf3a3ebdd892187e8e1194)
declare namespace Cloudflare {
	interface LocalEnv {
		...
		COMMUNITY_ENDPOINT_ALLOWED_GITHUB_IDS: "36901823,5099901,235942848,248917639,241978997,189873015,74301576,158852059,84981998,204561696";
	...
	interface StagingEnv {
		...
		STRIPE_AUTO_TOP_UP_PMC_ID: "pmc_1TUpob6O03AauPe8EgmA4mvg";
		STRIPE_PMC: "pmc_1SrYT96O03AauPe8ijLy6sZU";
		STAGING_ALLOWED_GITHUB_IDS: "36901823,5099901,235942848,248917639,241978997,189873015,74301576,158852059,84981998,204561696";
		COMMUNITY_ENDPOINT_ALLOWED_GITHUB_IDS: "36901823,5099901,235942848,248917639,241978997,189873015,74301576,158852059,84981998,204561696";
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
	...
	interface TestEnv {
		...
		STRIPE_SUCCESS_URL: "http://localhost:3000";
		BETTER_AUTH_URL: "http://localhost:3000";
		COMMUNITY_ENDPOINT_ALLOWED_GITHUB_IDS: "36901823";
		STRIPE_AUTO_TOP_UP_PMC_ID: "pmc_1TUpob6O03AauPe8EgmA4mvg";
		STRIPE_PMC: "pmc_1SrYT96O03AauPe8ijLy6sZU";
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
	...
	interface Env {
		...
		COMMUNITY_ENDPOINT_ALLOWED_GITHUB_IDS: "36901823,5099901,235942848,248917639,241978997,189873015,74301576,158852059,84981998,204561696" | "36901823";
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		PLN_ENTER_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "USAGE_DEBUG_USER_ID" | "CLOUDFLARE_ACCOUNT_ID" | "LOG_LEVEL" | "LOG_FORMAT" | "TINYBIRD_INGEST_URL" | "TINYBIRD_TIER_INGEST_URL" | "TINYBIRD_STRIPE_INGEST_URL" | "STRIPE_MODE" | "STRIPE_SUCCESS_URL" | "BETTER_AUTH_URL" | "STRIPE_AUTO_TOP_UP_PMC_ID" | "STRIPE_PMC" | "COMMUNITY_ENDPOINT_ALLOWED_GITHUB_IDS" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "PLN_ENTER_TOKEN" | "TINYBIRD_READ_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ELEVENLABS_API_KEY" | "OVHCLOUD_API_KEY" | "PLN_GPU_TOKEN" | "MUSIC_SERVICE_URL" | "SSH_RUNPOD_KLEIN" | "SSH_RUNPOD_FLUX_ZIMAGE" | "SSH_LAMBDA_SANA_LTX2_ACESTEP" | "TINYBIRD_INGEST_TOKEN" | "TINYBIRD_SYNC_TOKEN" | "DASHSCOPE_API_KEY" | "STAGING_ALLOWED_GITHUB_IDS">> {}
}
