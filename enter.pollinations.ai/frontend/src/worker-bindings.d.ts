...
// Generated by Wrangler by running `wrangler types --env-file /var/folders/jw/824hd4cn1g3g5bqjzts0w1gw0000gn/T/.sops1425951121/tmp-file3917245887 --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: 2b6af99f6bd0e50387e9a5f60d795912)
declare namespace Cloudflare {
	interface LocalEnv {
		...
		STRIPE_PMC: "pmc_1TbkNQ6O03AauPe8ynCC2Sly";
	...
	interface ProductionEnv {
		...
		STRIPE_PMC: "pmc_1TbkNT7rcjS3l7tr1RVkN6Q0";
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		PLN_ENTER_TOKEN: string;
	...
	interface Env {
		...
		STRIPE_PMC: "pmc_1TbkNQ6O03AauPe8ynCC2Sly" | "pmc_1TbkNT7rcjS3l7tr1RVkN6Q0";
		POLLEN_REFILL_PER_HOUR?: 1;
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "USAGE_DEBUG_USER_ID" | "CLOUDFLARE_ACCOUNT_ID" | "LOG_LEVEL" | "LOG_FORMAT" | "ALLOW_ANONYMOUS_USAGE" | "TINYBIRD_INGEST_URL" | "TINYBIRD_TIER_INGEST_URL" | "TINYBIRD_STRIPE_INGEST_URL" | "STRIPE_MODE" | "STRIPE_SUCCESS_URL" | "BETTER_AUTH_URL" | "STRIPE_AUTO_TOP_UP_PMC_ID" | "STRIPE_PMC" | "POLLEN_REFILL_PER_HOUR" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "PLN_ENTER_TOKEN" | "TINYBIRD_READ_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ELEVENLABS_API_KEY" | "OVHCLOUD_API_KEY" | "PLN_GPU_TOKEN" | "MUSIC_SERVICE_URL" | "SSH_RUNPOD_KLEIN" | "SSH_RUNPOD_FLUX_ZIMAGE" | "SSH_LAMBDA_SANA_LTX2_ACESTEP" | "TINYBIRD_INGEST_TOKEN" | "TINYBIRD_SYNC_TOKEN" | "DASHSCOPE_API_KEY">> {}
}
