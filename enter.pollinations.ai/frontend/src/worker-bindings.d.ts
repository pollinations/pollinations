...
// Generated by Wrangler by running `wrangler types --env-file /var/folders/nk/48zb93yj5kj0rwrdg4t3qsj40000gn/T/.sops3404230071/tmp-file1832481546 --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: 3da1575d2e263643f7aa4b590363aef4)
declare namespace Cloudflare {
	interface LocalEnv {
		...
		LOG_LEVEL: "trace";
		LOG_FORMAT: "text";
		D1_EXPORT_TOKEN_SHA256: "9eb69171319388c1231cd7452b717f4bda9c52a8a836cf7456326b4e3b7c79fb";
		TINYBIRD_INGEST_URL: "https://api.europe-west2.gcp.tinybird.co/v0/events?name=generation_event_v2";
	...
	interface ProductionEnv {
		...
		LOG_LEVEL: "debug";
		LOG_FORMAT: "json";
		D1_EXPORT_TOKEN_SHA256: "16787796e725ff98fa6d4c820922cc12fcf85a21bd1221abd984ef6cd1902a8d";
		TINYBIRD_INGEST_URL: "https://api.europe-west2.gcp.tinybird.co/v0/events?name=generation_event_v2";
		TINYBIRD_STRIPE_INGEST_URL: "https://api.europe-west2.gcp.tinybird.co/v0/events?name=stripe_event";
		STRIPE_MODE: "live";
	...
	interface Env {
		...
		D1_EXPORT_TOKEN_SHA256: "9eb69171319388c1231cd7452b717f4bda9c52a8a836cf7456326b4e3b7c79fb" | "16787796e725ff98fa6d4c820922cc12fcf85a21bd1221abd984ef6cd1902a8d" | "93b05a64761af544d325ac158513bef41959e8777a7375981ec7ae41f84cb05d";
		TINYBIRD_INGEST_URL: "https://api.europe-west2.gcp.tinybird.co/v0/events?name=generation_event_v2" | "http://localhost:7181/v0/events?name=generation_event_v2";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUDFLARE_ACCOUNT_ID" | "LOG_LEVEL" | "LOG_FORMAT" | "D1_EXPORT_TOKEN_SHA256" | "TINYBIRD_INGEST_URL" | "TINYBIRD_STRIPE_INGEST_URL" | "STRIPE_MODE" | "STRIPE_SUCCESS_URL" | "BETTER_AUTH_URL" | "STRIPE_AUTO_TOP_UP_PMC_ID" | "STRIPE_PMC" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "PLN_ENTER_TOKEN" | "TINYBIRD_READ_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ELEVENLABS_API_KEY" | "OVHCLOUD_API_KEY" | "PLN_GPU_TOKEN" | "SSH_RUNPOD_KLEIN" | "SSH_RUNPOD_FLUX_ZIMAGE" | "SSH_LAMBDA_SANA_LTX2_ACESTEP" | "TINYBIRD_INGEST_TOKEN" | "DASHSCOPE_API_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "STAGING_ALLOWED_GITHUB_IDS" | "STAGING_ALLOWED_EMAILS" | "USAGE_DEBUG_USER_ID">> {}
}
