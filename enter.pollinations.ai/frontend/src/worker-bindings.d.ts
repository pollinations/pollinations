...
// Generated by Wrangler by running `wrangler types --env-file /var/folders/jw/824hd4cn1g3g5bqjzts0w1gw0000gn/T/.sops4261996316/tmp-file2622654308 --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: 03baa4962b4a145a37c5a1885b174474)
declare namespace Cloudflare {
	interface LocalEnv {
		...
		STRIPE_PMC_USD: "pmc_1TYjwI6O03AauPe8spSyH3ph";
		STRIPE_PMC_BR: "pmc_1TYjxa6O03AauPe8w1niCN1s";
		STRIPE_PMC_APAC_ALIPAY: "pmc_1TYjxo6O03AauPe8hw5qidqt";
		STRIPE_PMC_EU_CORE: "pmc_1TYjy16O03AauPe8QDf9zVag";
		STRIPE_PMC_INDIA: "pmc_1Tbj1m6O03AauPe8YrA3inzu";
		STRIPE_PMC_UK: "pmc_1Tbj1g6O03AauPe8zYgi1YMc";
	...
	interface ProductionEnv {
		...
		STRIPE_BUY_POLLEN_PMC_ID: "pmc_1SrY4O7rcjS3l7trnGXDTuat";
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		PLN_ENTER_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "USAGE_DEBUG_USER_ID" | "CLOUDFLARE_ACCOUNT_ID" | "LOG_LEVEL" | "LOG_FORMAT" | "ALLOW_ANONYMOUS_USAGE" | "TINYBIRD_INGEST_URL" | "TINYBIRD_TIER_INGEST_URL" | "TINYBIRD_STRIPE_INGEST_URL" | "STRIPE_MODE" | "STRIPE_SUCCESS_URL" | "BETTER_AUTH_URL" | "STRIPE_AUTO_TOP_UP_PMC_ID" | "STRIPE_PMC_USD" | "STRIPE_PMC_BR" | "STRIPE_PMC_APAC_ALIPAY" | "STRIPE_PMC_EU_CORE" | "STRIPE_PMC_INDIA" | "STRIPE_PMC_UK" | "POLLEN_REFILL_PER_HOUR" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "PLN_ENTER_TOKEN" | "TINYBIRD_READ_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ELEVENLABS_API_KEY" | "OVHCLOUD_API_KEY" | "PLN_GPU_TOKEN" | "MUSIC_SERVICE_URL" | "SSH_RUNPOD_KLEIN" | "SSH_RUNPOD_FLUX_ZIMAGE" | "SSH_LAMBDA_SANA_LTX2_ACESTEP" | "TINYBIRD_INGEST_TOKEN" | "TINYBIRD_SYNC_TOKEN" | "DASHSCOPE_API_KEY" | "STRIPE_BUY_POLLEN_PMC_ID">> {}
}
