...
// Generated by Wrangler by running `wrangler types --env-file /var/folders/jw/824hd4cn1g3g5bqjzts0w1gw0000gn/T/.sops4280788370/tmp-file2946943380 --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: ce4066b437880e12503c7d42891db719)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUDFLARE_ACCOUNT_ID" | "LOG_LEVEL" | "LOG_FORMAT" | "TINYBIRD_INGEST_URL" | "TINYBIRD_STRIPE_INGEST_URL" | "STRIPE_MODE" | "STRIPE_SUCCESS_URL" | "BETTER_AUTH_URL" | "STRIPE_AUTO_TOP_UP_PMC_ID" | "STRIPE_PMC" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "PLN_ENTER_TOKEN" | "TINYBIRD_READ_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ELEVENLABS_API_KEY" | "OVHCLOUD_API_KEY" | "PLN_GPU_TOKEN" | "MUSIC_SERVICE_URL" | "SSH_RUNPOD_KLEIN" | "SSH_RUNPOD_FLUX_ZIMAGE" | "SSH_LAMBDA_SANA_LTX2_ACESTEP" | "TINYBIRD_INGEST_TOKEN" | "TINYBIRD_SYNC_TOKEN" | "DASHSCOPE_API_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "STAGING_ALLOWED_GITHUB_IDS" | "STAGING_ALLOWED_EMAILS" | "USAGE_DEBUG_USER_ID">> {}
}
