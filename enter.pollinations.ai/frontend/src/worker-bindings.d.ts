...
// Generated by Wrangler by running `wrangler types --env-file=/var/folders/nk/48zb93yj5kj0rwrdg4t3qsj40000gn/T/.sops247331371/tmp-file2688617992 --include-runtime=false --env-interface=CloudflareBindings worker-bindings.d.ts` (hash: d25bdc59f84b577c4e9ace78ee0883df)
interface __BaseEnv_CloudflareBindings {
	GIFT_CHECKOUT_LIMITER: RateLimit;
	GIFT_RECEIPT_LIMITER: RateLimit;
	GIFT_REDEEM_LIMITER: RateLimit;
	KV: KVNamespace;
	DB: D1Database;
