...
// Generated by Wrangler by running `wrangler types --env-file /var/folders/jw/824hd4cn1g3g5bqjzts0w1gw0000gn/T/.sops3454903166/tmp-file3972727517 --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: d20b824030f1e76a3fed34a1ce95fd30)
declare namespace Cloudflare {
	interface LocalEnv {
		KV: KVNamespace;
		DB: D1Database;
		TOP_UP_RATE_LIMITER: RateLimit;
		ENVIRONMENT: "local";
	...
	interface StagingEnv {
		...
		STRIPE_AUTO_TOP_UP_PMC_ID: "pmc_1TUpob6O03AauPe8EgmA4mvg";
		STRIPE_PMC: "pmc_1SrYT96O03AauPe8ijLy6sZU";
		STAGING_ALLOWED_GITHUB_IDS: "36901823,5099901,235942848,248917639,241978997,118118458";
