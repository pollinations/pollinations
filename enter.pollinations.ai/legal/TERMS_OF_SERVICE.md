...
**EU consumer withdrawal.** If you purchase as a consumer in the EU, you have a 14-day right of withdrawal for distance contracts. For digital content/services delivered immediately, this right is waived when you expressly consent to immediate delivery and acknowledge loss of the withdrawal right. We present this consent at checkout.

**Consent text:** "I request immediate access to the digital service and acknowledge that I will lose my 14-day withdrawal right once performance begins."
...
**How to request.** Contact hi@myceli.ai with order ID and account email. Refunds are returned to the original payment method subject to payment-network timelines.
