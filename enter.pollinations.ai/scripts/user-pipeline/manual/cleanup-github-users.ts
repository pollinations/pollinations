 ...
 *
 * Usage:
 *   npx tsx scripts/user-pipeline/manual/cleanup-github-users.ts audit --env production
 *   npx tsx scripts/user-pipeline/manual/cleanup-github-users.ts audit --env production --resume
 *   npx tsx scripts/user-pipeline/manual/cleanup-github-users.ts audit --env production --limit 50
 *   npx tsx scripts/user-pipeline/manual/cleanup-github-users.ts apply --env production
 *   npx tsx scripts/user-pipeline/manual/cleanup-github-users.ts apply --env production --no-dryRun
 *
