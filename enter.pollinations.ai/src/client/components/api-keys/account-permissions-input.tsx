...
const ACCOUNT_PERMISSIONS = [
    {
        id: "profile",
        label: "Profile",
        tooltip: "Read name, email, GitHub username, profile image, tier",
    },
    {
        id: "balance",
        label: "Balance",
        tooltip: "Read tier balance, pack balance, and key budget",
    },
    {
        id: "usage",
        label: "Usage",
        tooltip: "Read request history, spending, and model usage",
    },
] as const;
