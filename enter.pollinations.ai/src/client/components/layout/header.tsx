        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 sm:items-center">
            <div className="flex flex-col gap-2">
                <img
                    ...
                    alt="pollinations.ai"
                    className="h-12 w-full sm:w-auto object-contain object-center sm:object-left dark:hidden"
                />
                <img
                    src="/logo_text_white.svg"
                    alt="pollinations.ai"
                    className="h-12 w-full sm:w-auto object-contain object-center sm:object-left hidden dark:block"
                />
                <div className="flex flex-wrap justify-center sm:justify-start gap-1.5 text-xs">
                    <a
                        ...
                        className="bg-black/10 hover:bg-black/20 dark:bg-white/10 dark:hover:bg-white/20 transition-colors rounded-full px-2 py-0.5 whitespace-nowrap"
                    >
