                ...
                <div className="flex items-center gap-2">
                    ...
                    {showModelIdInfo && (
                        ...
                        >
                            ...
                            <span
                                className={`${showTooltip ? "visible" : "invisible"} group-hover/info:visible absolute left-0 top-full mt-1 px-3 py-2 bg-gradient-to-r from-pink-50 to-purple-50 text-gray-800 text-xs rounded-lg shadow-lg border border-pink-200 whitespace-nowrap z-50 pointer-events-none font-mono`}
                            >
                                {realModelId}
                            </span>
                        </span>
