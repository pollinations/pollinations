        ...
        <tr className="border-b border-gray-200">
            ...
            <td className="py-2 px-2 text-sm">
                <div className="flex justify-center">
                    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold ${model.type === 'image' ? 'uppercase' : ''}`} style={{backgroundColor: '#C8E6FF', color: '#1E3C95'}}>
                        ~{genPerPollen}
                    </span>
                </div>
            </td>
