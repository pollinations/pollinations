...
export const PriceBadge: FC<{ prices: (string | undefined)[], emoji: string, subEmojis: string[], perImage?: boolean, perToken?: boolean }> = ({ prices, emoji, subEmojis, perImage, perToken }) => {
