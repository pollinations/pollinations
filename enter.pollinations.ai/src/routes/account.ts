                            ...
                            schema: resolver(
                                z.object({
                                    ...
                                    pollenBudgetTier: z
                                        ...
                                        .nullable()
                                        .describe(
                                            "Remaining Quest/tier budget for this key, null = no separate tier cap",
                                        ),
                                    pollenBudgetPaid: z
                                        .number()
                                        .nullable()
                                        .describe(
                                            "Remaining Paid/pack budget for this key, null = no separate paid cap",
                                        ),
                                    allowPaidOnly: z
                                        .boolean()
                                        .describe(
                                            "Whether paid-only models are allowed on this key",
                                        ),
                                    rateLimitEnabled: z
                                        .boolean()
                                        .describe(
