...
const ModalitySchema = z
    ...
    .describe(
        'Upstream API family. "text" uses `/v1/chat/completions`; "image" uses `/v1/images/generations` and optionally `/v1/images/edits`; "video" uses synchronous `/v1/videos/generations`; "transcription" uses `/v1/audio/transcriptions`.',
    );
...
const EndpointFieldsSchema = {
    ...
    baseUrl: z
        ...
        .url()
        .describe(
            "OpenAI-compatible `/v1` base URL or full chat, image, video, or transcription URL.",
        ),
