                ...
                documentation: {
                    ...
                    info: {
                        ...
                        description: [
                            ...
                            "- **Publishable Keys (`pk_`):** For client-side apps, IP rate-limited (1 req/hour per IP+key). **Warning:** Exposing in public code will consume your Pollen if your app gets traffic.",
