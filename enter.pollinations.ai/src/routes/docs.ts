                ...
                documentation: {
                    ...
                    info: {
                        ...
                        description: [
                            ...
                            "**Generate an image:**",
                            "```",
                            "https://enter.pollinations.ai/api/generate/image/a%20cat?model=flux&key=YOUR_PUBLISHABLE_KEY",
                            "```",
                            "",
                            "**Generate text:**",
                            "```",
                            "https://enter.pollinations.ai/api/generate/text/hello%20world?key=YOUR_PUBLISHABLE_KEY",
                            "```",
                            "",
                            "**OpenAI-compatible endpoint:**",
                            "```bash",
                            'curl "https://enter.pollinations.ai/api/generate/openai" \\',
                            '  -H "Authorization: Bearer YOUR_API_KEY" \\',
                            '  -H "Content-Type: application/json" \\',
                            '  -d \'{"model":"perplexity-fast","messages":[{"role":"user","content":"What is AI?"}]}\'',
                            "```",
                            "",
                            "**Available models:**",
                            "- Images: https://enter.pollinations.ai/api/generate/image/models",
                            "- Text: https://enter.pollinations.ai/api/generate/openai/models",
                            "",
