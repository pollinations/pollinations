    ...
    .get(
        ...
        async (c) => {
            ...
            const products: ProductMap = {
                "product-pack-5x2": c.env.POLAR_PRODUCT_PACK_5X2,
                "product-pack-10x2": c.env.POLAR_PRODUCT_PACK_10X2,
                "product-pack-20x2": c.env.POLAR_PRODUCT_PACK_20X2,
                "product-pack-50x2": c.env.POLAR_PRODUCT_PACK_50X2,
            };
            try {
                const polar = c.var.polar.client;
