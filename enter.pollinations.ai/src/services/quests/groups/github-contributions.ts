...
const reportedIssueQuest: QuestDefinition = {
    ...
    description:
        "Report a bug or suggest an improvement in the Pollinations repository. Earn 5 Quest Pollen for each issue closed by a merged PR. App submissions and quest issues do not count.",
    category: CONTRIBUTION_CATEGORY,
    scope: "perUser",
    rewardAmount: 5,
    balanceBucket: "tier",
