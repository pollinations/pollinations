export const TIERS = {
    microbe: { pollen: 0, emoji: "🦠", color: "gray", cadence: "hourly" },
...
export function getTierCadence(tier: TierName): "daily" | "weekly" | "hourly";
export function getTierCadence(tier: string): "daily" | "weekly" | "hourly";
export function getTierCadence(tier: string): "daily" | "weekly" | "hourly" {
