...
test("OpenRouter Gemini adjustments use provider-reported cache and search usage", () => {
    ...
    const standardCacheWrite = calculateBillingAdjustments(
    ...
    expect(standardCacheWrite).toHaveLength(1);
    expect(standardCacheWrite[0].unitCost).toBeCloseTo(0.5 / 12_000_000, 15);
    expect(standardCacheWrite[0].cost).toBeCloseTo(0.5 / 12, 15);
