...
declare namespace Cloudflare {
	...
	interface LocalEnv {
		...
		COMMUNITY_ENDPOINT_ALLOWED_GITHUB_IDS: "36901823,5099901,235942848,248917639,241978997";
	...
	interface Env {
		...
		COMMUNITY_ENDPOINT_ALLOWED_GITHUB_IDS: "36901823,5099901,235942848,248917639,241978997" | "36901823";
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		PLN_ENTER_TOKEN: string;
