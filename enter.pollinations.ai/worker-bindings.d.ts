/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file /var/folders/jw/824hd4cn1g3g5bqjzts0w1gw0000gn/T/.sops3382287735/tmp-file285173873 --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: 6e87047bd93608492fd0ac8aec36d463)
declare namespace Cloudflare {
	...
	interface Env {
		...
		POLLEN_REFILL_PER_HOUR?: 1;
		POLLEN_RATE_LIMITER: DurableObjectNamespace /* PollenRateLimiter from pollinations-enter */ | DurableObjectNamespace<import("./src/index").PollenRateLimiter>;
		EDGE_RATE_LIMITER?: RateLimit;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "LOG_LEVEL" | "LOG_FORMAT" | "ALLOW_ANONYMOUS_USAGE" | "POLAR_SUCCESS_URL" | "POLAR_SERVER" | "TINYBIRD_INGEST_URL" | "TINYBIRD_POLAR_INGEST_URL" | "TINYBIRD_CRYPTO_INGEST_URL" | "TINYBIRD_TIER_INGEST_URL" | "TINYBIRD_STRIPE_INGEST_URL" | "IMAGE_SERVICE_URL" | "TEXT_SERVICE_URL" | "NOWPAYMENTS_ENV" | "STRIPE_MODE" | "STRIPE_SUCCESS_URL" | "POLLEN_REFILL_PER_HOUR" | "BETTER_AUTH_SECRET" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "PLN_ENTER_TOKEN" | "TINYBIRD_READ_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ELEVENLABS_API_KEY" | "OVHCLOUD_API_KEY" | "PLN_GPU_TOKEN" | "MUSIC_SERVICE_URL" | "SSH_RUNPOD_KLEIN" | "SSH_RUNPOD_FLUX_ZIMAGE" | "SSH_LAMBDA_SANA_LTX2_ACESTEP" | "TINYBIRD_INGEST_TOKEN" | "TINYBIRD_SYNC_TOKEN" | "DASHSCOPE_API_KEY">> {}
}
