/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime=false --env-interface CloudflareBindings worker-bindings.d.ts` (hash: 18722029790dd9ab18cb54974050f410)
declare namespace Cloudflare {
	...
	interface Env {
		...
		ENTER_TOKEN: string;
		RATE_LIMITER: DurableObjectNamespace /* RateLimiter from pollinations-enter */;
		DB: D1Database;
	}
}
