...
### Positioning & Signal Effect
- How would you position Pollinations to seed investors?
- Are there narratives or red flags that we should actively avoid?
- Which aspects of the story should be clear early on in your view?

### Equity Story & Pitch Feedback
- Feedback on the equity story (clear, credible, investable)
- Help with positioning ("What is Pollinations in one sentence?")
- Sparring on the founder story (motivation & credibility)
- Hints on which slides seed investors are really interested in

### Fundraising Strategy
- Assessment of whether the planned round size (€1.5M-€2.5M) is realistic
- Feedback on the runway setup (18 months target)
- Assessment of whether the setup is VC-compatible
- Warnings about structural errors (e.g. terms too complex)

### Investor Targeting & Intros
- Feedback on the investor list (who fits / who doesn't)
- Hints on which investors are likely to be interested
- Targeted warm intros
- Signal effect ("Antler is already invested")

### Support from Antler
- In which situations does Antler typically support with intros?
- At what point in the process does it make sense for Pollinations to reach back to you?
- Is there anything you would like from Pollinations so that you can support?

### Closing
- Are there any no-gos from your perspective that Pollinations should definitely avoid?
- Is there a topic missing from your perspective that we should definitely consider?
