# 🚀 SK: Seed Round Vorbereitung - Full Task List

> **⚠️ DRAFT - For Internal Review Only**

**Source**: Notion - SK: Seed Round Vorbereitung  
**Last Updated**: February 1, 2026  
**Notion URL**: https://www.notion.so/2f7b0a6c9b7a80ad93a8fbe71366b57b

---

## Quick Links

- **Vision**: [Story & Vision - Two Versions](https://www.notion.so/Story-Vision-Two-Versions-2f6b0a6c9b7a80a49ab4f012c4aee71e)
- **KPI Dashboard**: https://kpi.myceli.ai/
- **Business Plan**: https://docs.myceli.ai/
- **Fragen an Antler**: [Notion Page](https://www.notion.so/2f7b0a6c9b7a8001af55e0bc9e2a60cd)
...
- [ ] SAFE Antler - review
- [ ] Business plan von Elliot (docs.myceli.ai)
- [ ] KPI Meeting - zu Zahlen (Bootstrapping vs. what's the right amount to raise)
- [ ] Vision of Pollinations → Into Milestones 24 month
- [ ] Pitch Deck!
- [ ] Dilution Model review
...
| Task | Type | Prio | Status | Owner | Output |
|------|------|------|--------|-------|--------|
| Run first investor meetings | Execution | P0 | ⬜ | | Meeting-Notizen |
| Coordinate first close | Execution | P0 | ⬜ | | Unterschriebene Investment-Dokumente |
...
- [ ] Review & clean Notion setup

---

*Synced from Notion: SK: Seed Round Vorbereitung*
