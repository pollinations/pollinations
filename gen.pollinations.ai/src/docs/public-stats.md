...
| `GET /v0/pipes/app_directory_public.json` | `category`, `platform`, `limit` (1000) | The community app directory ([apps/apps.json](https://github.com/pollinations/pollinations/blob/main/apps/apps.json)) |
