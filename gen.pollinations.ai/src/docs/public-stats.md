...
| `GET /v0/pipes/weekly_health_stats.json` | `weeks_back` (12) | Weekly regular-user service availability (`2xx / (2xx + 5xx)`, cache excluded) and latency; excludes legacy APIs and internal/dev monitoring |
