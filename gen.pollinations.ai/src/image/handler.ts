...
// Register normalized request facts once so billing can select the matching
// cost variant. Aliases only resolve model identity; they never inject request
// parameters or select a price tier.
