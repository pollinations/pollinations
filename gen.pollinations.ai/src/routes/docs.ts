        ...
        tags: [
            ...
            },
            {
                ...
                description: [
                    ...
                    "",
                    "`gemini-embedding-2` supports text, image, audio, and video inputs. `text-embedding-3-small` and `text-embedding-3-large` are Azure OpenAI text-only models.",
                    "",
                    "String batch input supports up to 32 items. `task_type` is Gemini-only. Dimensions are model-specific: `text-embedding-3-small` supports up to 1536; `gemini-embedding-2` and `text-embedding-3-large` support up to 3072.",
                    "",
