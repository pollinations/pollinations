...
const SAFETY_DOCS = [
    "Optional `safe` checks request input before generation. Omitted, `false`, or `0` means off and does not run the safety checker.",
    "",
    "Values: `privacy` redacts PII, `secrets` redacts secrets, `sexual` / `violence` / `shield` block matching requests. Aliases: `true` = `privacy,secrets`, `nsfw` = `sexual,violence`.",
    "",
    "Use it as a query parameter or request body field:",
    "",
    "```bash",
