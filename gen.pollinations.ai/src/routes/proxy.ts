    ...
    .get(
        ...
        describeRoute({
            ...
            description: [
                ...
                "",
                "For models with `reference_videos` in `video_capabilities`, use `input_reference_videos` for motion transfer and style reference.",
                "",
                "For models with `reference_audios` in `video_capabilities`, use `input_reference_audios` for audio-driven generation. Reference them in your prompt as [Audio1], [Audio2], etc.",
                "",
