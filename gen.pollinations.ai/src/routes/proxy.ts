    ...
    .get(
        ...
        describeRoute({
            ...
            description: [
                ...
                "",
                "**Billing:** requires paid pack balance. Gen proxies the WebSocket, aggregates observed `response.done` usage, and deducts one session total when the socket closes.",
            ].join("\n"),
            responses: {
                101: {
