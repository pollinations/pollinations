    ...
    .get(
        ...
        describeRoute({
            ...
            description: [
                ...
                "",
                "For models with `reference_images` in `video_capabilities`, use `input_references` to pass image URLs for visual guidance without fixing the first or last frame.",
                "",
