...
export const AVastDeepOceanSceneFilledWithDriftingBioluminescentLifeSoftDarknessWithVolumetricBlueHazeDiverseGlowingOrganismsOfDifferentColorsTurquoiseVioletAmberSoftPinkSizesTinySpecksToLargeFloatingFormsAndShapesJellCopy = {
  ...
  "APPS_PAGE.subtitle.text": "Drifting apps and experiments, glowing in the deep.",
  "COMMUNITY_PAGE.title.text": "Contribute",
  "COMMUNITY_PAGE.subtitle.text": "A submerged sanctuary where creators and developers pulse with bioluminescent light together.",
  "COMMUNITY_PAGE.newsTitle.text": "What's New",
  "COMMUNITY_PAGE.newsFilePath": "/NEWS.md",
  "COMMUNITY_PAGE.discordTitle.text": "Discord",
  "COMMUNITY_PAGE.discordSubtitle.text": "Drift into our glowing currents for deep support.",
  "COMMUNITY_PAGE.githubTitle.text": "GitHub",
  "COMMUNITY_PAGE.githubSubtitle.text": "Build glowing forms in open source waters.",
  ...
  "COMMUNITY_PAGE.supportersSubtitle.text": "Thanks to supporters who illuminate our vast, dark depths.",
