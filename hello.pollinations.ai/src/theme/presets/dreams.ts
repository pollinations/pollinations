...
export const CrazyDreamsCssVariables = processTheme(CrazyDreamsTheme).cssVariables;

// Copy from: "crazy dreams"
export const CrazyDreamsCopy = {
  "APPS_PAGE.title.text": "Ecosystem",
  "APPS_PAGE.subtitle.text": "Paradise-built apps, tools, and experiments—Pollinations-powered. Browse, try, ship.",
  "COMMUNITY_PAGE.title.text": "Contribute",
  "COMMUNITY_PAGE.subtitle.text": "We're crafting a haven where developers, creators, and AI enthusiasts collaborate and bloom together.",
  "COMMUNITY_PAGE.newsTitle.text": "What's New",
  "COMMUNITY_PAGE.newsFilePath": "https://raw.githubusercontent.com/pollinations/pollinations/production/NEWS/transformed/highlights.md",
  "COMMUNITY_PAGE.discordTitle.text": "Discord",
  "COMMUNITY_PAGE.discordSubtitle.text": "Join our sunlit community for chats and support.",
  "COMMUNITY_PAGE.githubTitle.text": "GitHub",
  "COMMUNITY_PAGE.githubSubtitle.text": "Collaborate on open-source projects and contribute code.",
  ...
  "COMMUNITY_PAGE.votingSubtitle.text": "We build what the community wants. Vote on what matters to you:",
  "COMMUNITY_PAGE.votingIssues.0.emoji": "🤖",
  "COMMUNITY_PAGE.votingIssues.0.title": "Which models should we add next?",
  "COMMUNITY_PAGE.votingIssues.0.url": "https://github.com/pollinations/pollinations/issues/5321",
  "COMMUNITY_PAGE.votingIssues.1.emoji": "💳",
  "COMMUNITY_PAGE.votingIssues.1.title": "What payment methods do you want?",
  "COMMUNITY_PAGE.votingIssues.1.url": "https://github.com/pollinations/pollinations/issues/4826",
  "COMMUNITY_PAGE.votingIssues.2.emoji": "🔐",
  "COMMUNITY_PAGE.votingIssues.2.title": "What login providers do you want?",
  "COMMUNITY_PAGE.votingIssues.2.url": "https://github.com/pollinations/pollinations/issues/5543",
  "COMMUNITY_PAGE.supportersTitle.text": "Supporters",
  "COMMUNITY_PAGE.supportersSubtitle.text": "We're grateful to our supporters for their contributions to the platform.",
  ...
  "DOCS_PAGE.imageParameters.2.description": "Random seed for reproducible results",
  ...
  "DOCS_PAGE.textParameters.2.description": "Creativity (0=strict, 2=creative)",
  ...
  "DOCS_PAGE.publishableFeature2.text": "Rate limited: 3 req/burst, 1/15sec refill",
  "DOCS_PAGE.publishableFeature3.text": "Best for: demos, prototypes, public tools",
  ...
  "HELLO_PAGE.heroIntro.text": "A community-driven platform where developers, artists, and tinkerers build together. No gatekeeping, no corporate nonsense — just good tools and good people.",
  "HELLO_PAGE.heroTagline.text": "APIs built in the open. Loved by developers. Powered by community.",
  ...
  "HELLO_PAGE.whatIsTagline.text": "No black boxes. No vendor lock-in. Just a friendly API and a Discord full of people who actually help each other.",
  "HELLO_PAGE.pollenTitle.text": "Pollen",
  "HELLO_PAGE.pollenDescription.text": "Running AI models costs money. Pollen is how we keep the servers humming without ads or selling your data. One simple credit across all models — predictable, transparent, no surprises. Two ways to get it:",
  ...
  "HELLO_PAGE.buyCardDescription.text": "Grab some Pollen and help keep Pollinations running. No subscriptions, no tricks — just straightforward support.",
  "HELLO_PAGE.earnCardTitle.text": "Contribute & Get Pollen",
  "HELLO_PAGE.earnCardDescription.text": "Active community members get free Pollen. Ship an app, help others in Discord, fix a bug, write docs — we notice and we share.",
  "HELLO_PAGE.tiersSubtitle.text": "Grow",
  "HELLO_PAGE.tiersDescription.text": "Start small, contribute, watch your Pollen grow:",
  "HELLO_PAGE.tierSporeTitle.text": "🦠 Spore — Just arrived",
  "HELLO_PAGE.tierSporeDescription.text": "Welcome! Here's some Pollen to play with.",
  "HELLO_PAGE.tierSeedTitle.text": "🌱 Seed — Part of the community",
  "HELLO_PAGE.tierSeedDescription.text": "You're on GitHub or Discord, you've said hi. More Pollen for you.",
  "HELLO_PAGE.tierFlowerTitle.text": "🌸 Flower — You shipped something",
  "HELLO_PAGE.tierFlowerDescription.text": "You built an app with Pollinations. Nice! Even more Pollen.",
  "HELLO_PAGE.tierNectarTitle.text": "🍯 Nectar — Community pillar",
  "HELLO_PAGE.tierNectarDescription.text": "Your work helps others. You're part of what makes this place good.",
  "HELLO_PAGE.questsSubtitle.text": "Ways to Contribute",
  "HELLO_PAGE.questsDescription.text": "Fix a bug, answer a question, share what you built, improve the docs. Every contribution matters and gets recognized.",
  ...
  "HELLO_PAGE.whyChooseFeature3.text": "No BS Pricing — Pollen is simple and transparent. You always know what you're paying.",
  "HELLO_PAGE.whyChooseFeature4.text": "Community-Driven — the roadmap comes from Discord conversations, not boardrooms.",
  "HELLO_PAGE.whyChooseFeature5.text": "Fully Open Source — every line of code is on GitHub. Fork it, read it, improve it.",
  "HELLO_PAGE.communityTitle.text": "Built Together",
  "HELLO_PAGE.communityDescription.text": "Students, indie devs, artists, researchers, hobbyists — all building weird and wonderful things together. Jump into Discord, browse the GitHub, see what people are making. This is a place where people actually help each other.",
  ...
  "HELLO_PAGE.roadmapItem1Description.text": "Call the API from the browser — no backend needed.",
  "HELLO_PAGE.roadmapItem2Title.text": "User Pollen",
  "HELLO_PAGE.roadmapItem2Description.text": "Your users bring their own Pollen. You build, they pay for what they use.",
  ...
  "HELLO_PAGE.roadmapItem4Description.text": "Video, real-time, and whatever comes next.",
