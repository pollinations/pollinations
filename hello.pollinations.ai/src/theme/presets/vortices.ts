...
export const  = processTheme().cssVariables;

// Copy from: "“A hyper-abstract storm of cute biological forms in constant transformation. Swirling pastel vortices filled with mutating round creatures, fractal pollen bursts, liquid-soft shapes splitting, merging, bending, and blooming. Everything pulses, twists, stretches, ricochets gently, and collides in surreal choreography. Colors explode in shifting gradients of neon-pastel (electric peach, cosmic lavender, hot mint, plasma yellow, pearlescent pink). Creatures are barely definable: morphing puff-spheres with eyes, elastic petal-limbs, fuzzy orbs that ripple like jelly, pollen-threads that braid and unbraid in midair. Motion is slow but overwhelmingly complex — spirals, loops, cascades, soft eruptions. The entire scene feels like an otherworldly biological rave: intense, dreamy, childlike, chaotic, and impossibly cute. 3D, deep parallax, shimmering particles, infinite seamless loop."
export const  = {
