...
function testEmbeddingSimilarities() {
    ...
    console.log('📝 Note: This uses simulated embeddings to demonstrate the concept.');
    ...
    console.log(`✅ Base embedding generated (${baseEmbedding.length} dimensions - simulated)\n`);
    ...
    for (const variation of variations) {
        ...
        console.log(`| ${variation.padEnd(25)} | ${normalized.padEnd(25)} | ${similarity.toFixed(4)} | ${aboveThreshold ? '✅ YES' : '❌ NO'} | ${notes} |`);
    }
    ...
    console.log('- Normalization removes punctuation, so dots should have minimal impact');
    ...
    console.log('- These are below the 0.8 threshold, showing the model is quite strict');
}
