...
const templatesAndPrompts = [
    {
      ...
      {
        "template": "analog film photo {prompt} . faded film, desaturated, 35mm photo, grainy, vignette, vintage, Kodachrome, Lomography, found footage",
        "prompts": [
          "city street",
          "beach",
          "mountain landscape",
      ...
      {
        "template": "{prompt} . shallow depth of field, vignette, highly detailed, high budget, bokeh, moody, epic, gorgeous, film grain, grainy",
        "prompts": [
          "person portrait",
          "still life",
          "landscape",
      ...
      {
        "template": "neonpunk style {prompt} . cyberpunk, vaporwave, neon, vibes, vibrant, stunningly beautiful, crisp, detailed, sleek, ultramodern",
        "prompts": [
           "cityscape",
          "character", 
          "vehicle",
      ...
      {  
        "template": "cinematic still {prompt} . emotional, harmonious, vignette, highly detailed, high budget, bokeh, cinemascope, moody, gorgeous, film grain, grainy",
        "prompts": [
          "portrait",
          "landscape",  
          "cityscape",
  ...
  {
    "template": "glitch art portrait {prompt} . digital distortion, VHS overlay, retro cyber effects, pixelated errors",
    "prompts": [
      "man",
      "woman",
      "nonbinary person",    
  ...
  {
    "template": "HDR urban photography {prompt} . high dynamic range, crisp details, vivid colors, cityscape focus",  
    "prompts": [
      "street scene",
      "downtown",
      "bridge", 
  ...
  { 
    "template": "charcoal sketch {prompt} . rough textures, gradations of black and white, smudged shading, realistic",
    "prompts": [
      "person", 
      "still life",
      "animal",  
  ...
  {
    "template": "psychedelic abstract {prompt} . vibrant swirls, optical illusions, bold colors, reminiscent of 1960s art", 
    "prompts": [  
      "swirling vortex",
      "cosmic waves",  
      "sacred geometry", 
  ...
  {
    "template": "8mm vintage travel film {prompt} . grainy texture, sepia tones, flickering effect, nostalgic feel",
    "prompts": [
      "bustling market",
      "quiet village",  
      "winding road",
  ...
  {  
    "template": "digital vector illustration {prompt} . clean lines, flat colors, Adobe Illustrator style, modern graphic",
    "prompts": [
      "animal",   
      "person", 
      "still life",
  ...
  {
    "template": "macro nature photography {prompt} . extreme close-up, detailed textures, bokeh background, vivid flora or fauna",
    "prompts": [
      "insect",
      "flower", 
      "leaf", 
  ...
  {
    "template": "gothic fantasy {prompt} . dark and brooding atmosphere, medieval architecture, mythical creatures",
    "prompts": [  
      "ominous castle",
      "forbidden forest",  
      "witches coven",
  ...
  {
    "template": "holographic 3D model {prompt} . futuristic, shimmering rainbow effects, translucent, light-interactive",
    "prompts": [
      "vehicle",    
      "building",
      "creature",
  ...
  {
    "template": "experimental mixed media {prompt} . collage elements, diverse materials, avant-garde, textural contrasts", 
    "prompts": [
      "surreal portrait",
      "dreamlike landscape",  
      "abstract still life",
    ...
    {
      "template": "risograph art print {prompt} . layered colors, grainy texture, limited color palette, retro vibe",
      "prompts": [
    ...
    {
      "template": "minimalist Scandinavian design {prompt} . clean lines, muted colors, functional and modern, natural elements",
      "prompts": [
        "furniture",
        "clothing",
        "houseware",
    ...
    {
      "template": "Japanese ink wash painting {prompt} . sumi-e style, brush strokes, monochrome, Zen-like simplicity",
      "prompts": [
        "landscape",
        "animal",
        "flower",
    ...
    {
      "template": "graffiti street art {prompt} . bold colors, urban style, spray paint textures, street culture",
      "prompts": [  
          "character",
         "typography",
        "abstract shapes", 
    ...
    {
      "template": "noir film scene {prompt} . black and white, high contrast, shadowy, 1940s detective film vibe",
      "prompts": [ 
         "back alley",
        "smoky office",
        "pool hall",  
    ...
    {
      "template": "virtual reality landscape {prompt} . futuristic, immersive, 360-degree view, digital world", 
      "prompts": [
          "alien planet",
         "cyberspace",
        "mystical realm", 
    ...
    {
      "template": "bioluminescent underwater scene {prompt} . glowing creatures, deep sea, mysterious, vibrant colors",
      "prompts": [
        "jellyfish",  
        "seabed",
        "coral reef",   
    ...
    {
      "template": "medieval manuscript illustration {prompt} . illuminated letters, gold leaf, intricate borders, historical", 
      "prompts": [  
         "fantasy story", 
        "nature scene",
        "castle siege", 
    ...
    {
      "template": "surreal cosmic landscape {prompt} . otherworldly, starry skies, floating elements, dreamy colors",
      "prompts": [    
        "alien world",
        "mystical realm", 
        "heavenly clouds",
    ...
    {
      "template": "claymation character design {prompt} . stop-motion style, textured, whimsical, playful",  
      "prompts": [
        "human",
        "animal",  
        "fantasy creature",
    ...
    {
      "template": "woodblock print nature scene {prompt} . traditional Japanese style, layered, natural patterns", 
      "prompts": [
        "mountains",
        "forest",   
        "garden", 
        ...
        "landscape as mindscape"
            ...
            {
              "template": "interactive 3D game environment {prompt} . immersive, realistic textures, dynamic lighting, engaging",
              "prompts": [
                "fantasy world",
                "sci-fi city",
                "natural landscape",
            ...
            {
              "template": "pop art advertisement {prompt} . bold colors, comic style, 1960s vibe, catchy tagline",
              "prompts": [
                "soda",
                "fast food",
                "appliance",
            ...
            {
              "template": "ambient mood scene {prompt} . soft lighting, calming colors, tranquil, soothing atmosphere",
              "prompts": [
                "candlelit room",
                "rainy window",
                "sunset sky",
            ...
            {
              "template": "steampunk gadget design {prompt} . mechanical parts, bronze and copper, Victorian era, intricate gears",
              "prompts": [
                "time machine", 
                "robot",
                "vehicle",
            ...
            {
              "template": "Cyberpunk city at night {prompt} . neon lights, futuristic buildings, dystopian, rain-soaked streets",
              "prompts": [
                "downtown",  
                "plaza",
                "alleyway", 
            ...
            {
              "template": "Impressionist landscape painting {prompt} . quick brush strokes, light effects, vibrant, Monet-inspired",
              "prompts": [
                "garden",  
                "riverbank",
                "poppy field",
            ...
            {
              "template": "Cubist abstract composition {prompt} . geometric shapes, fragmented objects, Picasso-esque style",
              "prompts": [
                "portrait",
                "still life",  
                "cityscape",
            ...
            {
              "template": "Candid urban photography {prompt} . spontaneous, street life, black and white, human elements",
              "prompts": [
                "market scene",
                "café patrons",  
                "park bench",
            ...
            {
              "template": "Augmented reality art experience {prompt} . immersive, interactive, blending real and virtual elements", 
              "prompts": [
                "abstract shapes",
                "fantasy forest",  
            ...
            {
              "template": "Contemporary performance art scene {prompt} . dynamic, conceptual, human expression, avant-garde",
              "prompts": [  
                "movement study",
                "interpretive dance",
                "theatrical tableau",
            ...
            {
              "template": "Infrared landscape photography {prompt} . surreal colors, otherworldly, ethereal, nature-focused",
              "prompts": [
                "forest",  
                "desert",
                "waterfront",
            ...
            {  
              "template": "Land art installation {prompt} . natural materials, outdoor setting, earthworks, environmental theme",
              "prompts": [
                "field of wheat",  
                "stone pathway",
                "spiraling rocks", 
            ...
            {
              "template": "Korean Minhwa painting {prompt} . folk art, vibrant colors, mythical creatures, traditional motifs",
              "prompts": [   
                "tiger", 
                "dragon",
                "phoenix",  
            ...
            {
              "template": "Stop-motion animation scene {prompt} . frame-by-frame, detailed, whimsical, story-driven",
              "prompts": [
                "clay forest",  
                "paper ocean", 
                "fabric meadow",
            ...
            { 
              "template": "Political caricature {prompt} . exaggerated features, humorous, critical, editorial style",
              "prompts": [
                "world leader",   
                "corporate executive",
            ...
            {
              "template": "Eco-futuristic city design {prompt} . green architecture, sustainable living spaces, integration with nature", 
              "prompts": [ 
                "residential complex",
                "office towers",  "urban farm",
                "solar structures",
                "green skyline"
              ]
            },
            {
              "template": "Victorian fashion sketch {prompt} . detailed period clothing, elegant postures, ornate accessories",
              "prompts": [  
                "noblewoman",
                "debutante",    
                "opera patron",
            ...
            {
              "template": "Artistic gourmet dish presentation {prompt} . culinary art, creative plating, vibrant colors, gastronomy focus",
              "prompts": [
                "salad",  
                "quiche",
                "seafood platter",    
            ...
            {
              "template": "West African mask design {prompt} . bold patterns, ritual significance, cultural symbolism", 
              "prompts": [
                "spirit guide",   
                "royal visage",
                "character archetype",
                ...
                {
                  "template": "Surrealist dreamscape {prompt} . subconscious imagery, Freudian symbols, bizarre landscapes",
                  "prompts": [
                    "melting clocks",
                    "floating stairs",
                    "eyeballs and clouds",
                ...
                {
                  "template": "Plein air city drawing {prompt} . on-site sketching, lively street scenes, watercolor and ink",
                  "prompts": [
                    "busy intersection",
                    "public market",
                    "riverside walk",
                ...
                {
                  "template": "Abstract animation sequence {prompt} . non-linear storytelling, experimental visuals, mixed media",
                  "prompts": [
                    "rippling patterns",  
                    "cosmic waves",
                    "morphing geometry",
                ...
                {
                  "template": "Revivalist building design {prompt} . classical elements, symmetry, grandeur, inspired by Ancient Greece and Rome",
                  "prompts": [
                ...
                {
                  "template": "Stained glass window design {prompt} . vibrant colors, light effects, intricate patterns", 
                  "prompts": [
                    "natural landscape",
                    "religious scene",    
                    "fantasy story",
                ...
                {
                  "template": "Expressive art therapy painting {prompt} . emotional release, abstract expression, therapeutic process",
                  "prompts": [   
                    "anger issues",
                    "grief process",  
                    "self-discovery",
                ...
                {
                  "template": "Traditional puppet character {prompt} . handcrafted, intricate costumes, storytelling tools",
                  "prompts": [
                    "folklore hero",  
                    "trickster fox",
                    "wizard mentor", 
                ...
                {
                  "template": "Fantasy makeup look {prompt} . creative face painting, theatrical effects, character transformation",
                  "prompts": [
                    "forest nymph",   
                    "techno android",
                    "demonic entity",  
                ...
                {
                  "template": "Ancient Mural Reconstruction {prompt} . historic scenes, faded frescoes, archaeological style",
                  "prompts": [    
                ...
                {
                  "template": "Rococo-Inspired Scene {prompt} . ornate, gold leaf, pastel colors, opulent, 18th-century elegance", 
                  "prompts": [  
                ...
                {
                  "template": "Digital Glitch Art {prompt} . malfunction aesthetics, pixel shatter, color dispersion, modern digital",
                  "prompts": [  
                ...
                {
                  "template": "Art Brut/Outsider Art {prompt} . raw, non-conformist, intense expression, untrained artist style",
                  "prompts": [ 
                    "visionary symbols",    
                    "extreme emotions",
                ...
                {
                  "template": "Psychedelic Poster Design {prompt} . 1960s revival, trippy visuals, bright neon, Hendrix-era vibe",
                  "prompts": [
                    "music festival", 
                    "counterculture film", 
                ...
                {
                  "template": "Artisanal Jewelry Design {prompt} . handcrafted jewelry, intricate metalwork, gemstone details, luxury craftsmanship",
                  "prompts": [  
                    "gemstone pendant",
                    "art deco ring",    
                ...
                {
                  "template": "Sandstone Carving {prompt} . ancient style, detailed relief work, weathered stone texture",
                  "prompts": [
                    "epic battle scene",   
                    "sacred symbols",
                    "royal history",   
                ...
                {
                  "template": "Hyperrealistic Miniature Painting {prompt} . small scale, detailed brushwork, lifelike miniatures", 
                  "prompts": [
                ...
                {
                  "template": "Aerospace Concept Art {prompt} . futuristic spacecraft, interstellar travel, high-tech, NASA-inspired",
                  "prompts": [ 
                    "Mars exploration",   
                ...
                {
                  "template": "Mandala Art {prompt} . symmetrical, intricate patterns, spiritual symbolism, colorful",
                  "prompts": [   
                    "chakra energies",  
                    "healing themes",
                    "natural elements", 
                ...
                {
                  "template": "Silhouette Animation {prompt} . contrast, shadow play, narrative storytelling, Lotte Reiniger style", 
                  "prompts": [ 
                    "folk tale",
                    "fable",  
                    "gothic tale",
                ...
                {
                  "template": "Shadow Box Art {prompt} . layered paper, depth illusion, diorama style, intricate cutouts", 
                  "prompts": [    
                    "storybook scene ", 
                    "memory capsule",
                    "mythical landscape",  
                ...
                {  
                  "template": "Street Mural in 3D {prompt} . optical illusion, large-scale, urban art, interactive pavement",
                  "prompts": [ 
                    "deep sea diving ", 
                    "alternate universe",
                    "surreal funhouse",   
                ...
                {
                  "template": "Art Therapy Collage {prompt} . mixed media, emotional expression, personal narratives, therapeutic process",
                  "prompts": [
                ...
                {
                  "template": "Lace Making {prompt} . delicate patterns, textile art, traditional craftsmanship, intricate", 
                  "prompts": [  
                    "floral motifs",
                    "geometric designs",    
                    "ornate heirloom",
                ...
                {
                  "template": "Botanical Illustration {prompt} . scientific accuracy, detailed plant life, naturalist style",
                  "prompts": [   
                    "rare orchids",
                    "medicinal herbs",   
                    "carnivorous species",
                ...
                {
                  "template": "Encaustic (Wax) Painting {prompt} . ancient technique, layered wax, textural, vibrant",
                  "prompts": [    
                    "abstract expression",  
                    "conceptual portrait",
                    "dreamlike landscape",    
                ...
                {
                  "template": "Paper Quilling Art {prompt} . rolled paper, 3D effects, intricate designs, decorative",
                  "prompts": [   
                    "synaptic mind map",
                    "flower bouquet",    
                    "animal portrait",
                ...
                {
                  "template": "Neo-Expressionist Painting {prompt} . bold colors, emotive, modern abstraction, Basquiat-inspired",
                  "prompts": [  
                    "urban commentary",
                    "raw self-portrait",    
                    "primal symbolism",
  ...
  {
    "template": "Technical Illustration: Machinery {prompt} . Precision engineering, detailed components, industrial aesthetic",
    "prompts": [
  ...
  {
    "template": "Microscopic Imagery {prompt} . Cellular beauty, scientific accuracy, vibrant colors",
    "prompts": [
  ...
  {
    "template": "Technical Diagram: Electronics {prompt} . Schematic precision, functional design, modern technology",
    "prompts": [
  ...
  {
    "template": "3D Rendering: Architectural {prompt} . Structural elegance, architectural marvels, photorealistic detail",
    "prompts": [
  ...
  {
    "template": "Particle Systems Visualization {prompt} . Dynamic simulations, fluid movements, abstract forms",
    "prompts": [
  ...
  {
    "template": "Point Cloud Imaging {prompt} . Spatial complexity, 3D data representation, topographical accuracy",
    "prompts": [
  ...
  {
    "template": "Exploded View Illustration {prompt} . Deconstructed complexity, mechanical insights, clear visualization",
    "prompts": [
  ...
  {
    "template": "Blueprint Design: Vehicle {prompt} . Engineering precision, technical layouts, innovative designs",
    "prompts": [
  ...
  {
    "template": "Anatomical Study: Human Body {prompt} . Biological intricacy, lifelike representations, medical precision",
    "prompts": [
  ...
  {
    "template": "Astronomical Chart {prompt} . Celestial wonders, cosmic exploration, stellar beauty",
    "prompts": [
  ...
  {
    "template": "Renaissance Engineering Sketches {prompt} . Historical ingenuity, classical design, Da Vinci-inspired",
    "prompts": [
  ...
  {
    "template": "Fantasy Cartography {prompt} . Imaginary worlds, adventurous routes, mythical landmarks",
    "prompts": [
  ...
  {
    "template": "Steampunk Inventions {prompt} . Retro-futuristic machinery, Victorian-era aesthetics, imaginative designs",
    "prompts": [
  ...
  {
    "template": "Retro Sci-Fi Illustrations {prompt} . Vintage space age, atomic era designs, nostalgic futurism",
    "prompts": [
  ...
  {
    "template": "Dystopian Cityscapes {prompt} . Post-apocalyptic environments, urban decay, surreal atmospheres",
    "prompts": [
  ...
  {
    "template": "Surreal Dreamscapes {prompt} . Dreamlike visuals, abstract forms, ethereal themes",
    "prompts": [
  ...
  {
    "template": "Bio-Mechanical Concepts {prompt} . Fusion of organic and mechanical, futuristic symbiosis, intricate details",
    "prompts": [
  ...
  {
    "template": "Art Deco Revival {prompt} . Modern twist on classic style, geometric elegance, luxurious patterns",
    "prompts": [
  ...
  {
    "template": "Whimsical Food Art {prompt} . Playful food arrangements, imaginative culinary creations, colorful compositions",
    "prompts": [
  ...
  {
    "template": "Optical Illusion Art {prompt} . Mind-bending designs, visual tricks, perception-challenging",
    "prompts": [
  ...
  {
    "template": "Mythical Creature Design {prompt} . Legendary beings, fantastical anatomy, imaginative interpretation",
    "prompts": [
  ...
  {
    "template": "fauvism painting of {prompt} . bold colors, expressive brush strokes, simplified forms ",
    "prompts": [
      "figure",
      "still life",
      "landscape",
  ...
  {
    "template": "art nouveau illustration of a {prompt} . flowing organic lines, floral motifs, elegant style",
    "prompts": [
      "woman",
      "insect",
      "plant",
  ...
  {
    "template": "pointillism painting of {prompt} . tiny dots of pure color, mix optically, Seurat style",
    "prompts": [
      "park scene",
      "river landscape",
      "cafe interior",
  ...
  {
    "template": "ukiyo-e woodblock print of a {prompt} . flat shapes, visible brush strokes, Japanese style",
    "prompts": [
      "geisha",
      "samurai",
      "bird", 
  ...
  {
    "template": "pop surrealism painting featuring {prompt} . imaginative, dreamlike, boldly stylized",
    "prompts": [
      "a figure",
      "a creature",
      "a landscape",
  ...
  {
    "template": "op art piece with {prompt} . optical illusions, disorienting patterns, seem to vibrate",
    "prompts": [
  ...
  { 
    "template": "minimalist painting of a {prompt} . extremely simplified, basic colors and shapes", 
    "prompts": [
      "figure",
      "fruit",
      "vardscape",
  ...
  {
    "template": "action painting featuring {prompt} . bold strokes, splatters, drips, dynamic style",
    "prompts": [
      "vibrant colors",
  ...
  {
    "template": "romantic seascape with {prompt} . turbulent oceans, awe-inspiring skies, J.M.W Turner style",
    "prompts": [
      "stormy waves",
      "rocky cliffs",
      "old shipwrecks",
  ...
  {
    "template": "nonsense poetry illustration depicting {prompt} . avant-garde, surreal juxtapositions ",
    "prompts": [
  ...
  {
    "template": "magic realism painting of a {prompt} . dreamlike precision, marvelous realism", 
    "prompts": [
      "mysterious figure",
      "floating object",
...
export const prompts = templatesAndPrompts.map(templateAndPrompt => {
    return templateAndPrompt.prompts.map(prompt => {
        return { searchPrompt: templateAndPrompt.template.replace("{prompt}", prompt), template: templateAndPrompt.template, prompt: prompt};
    });
}).flat();
