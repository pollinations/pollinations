...
ssh $HOST "git clone -b master https://github.com/pollinations/pollinations.git /root/pollinations 2>/dev/null || (cd /root/pollinations && git fetch origin && git checkout master && git pull)"
