export const MODELS = {
    ...
    "kontext": { type: "kontext", enhance: true, maxSideLength: 640, tier: "seed" }, // Flux Kontext general purpose model
    "turbo": { type: "pollinations", enhance: true, maxSideLength: 768 }, // Assuming 'turbo' is of type 'sd'
    "gptimage": { type: "azure", enhance: false, maxSideLength: 1024, tier: "flower" }, // Azure GPT Image model
    "sora": { type: "azure", enhance: false, maxSideLength: 1920, tier: "flower" } // Azure Sora video model
};