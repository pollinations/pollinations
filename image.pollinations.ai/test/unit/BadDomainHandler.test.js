...
describe("BadDomainHandler", () => {
  ...
  describe("processPrompt", () => {
    ...
    it("transforms prompts for bad domains when random value is low", async () => {
      ...
      const result = await badDomainHandler.processPrompt("original prompt", {
    ...
    it("caches results with the same parameters", async () => {
      ...
      const result1 = await badDomainHandler.processPrompt("test prompt", {
        referer: "good-site.com",
      });
      ...
      const result2 = await badDomainHandler.processPrompt("test prompt", {
        referer: "good-site.com",
      });
