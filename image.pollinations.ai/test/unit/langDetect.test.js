...
describe("detectEnglish", () => {
    it("should return true for English text", async () => {
        ...
        expect(exec).toHaveBeenCalledWith(
            'python langdetect.py "Hello world"',
            expect.any(Function),
        );
    });
    ...
    it("should return false for non-English text", async () => {
        ...
        expect(exec).toHaveBeenCalledWith(
            'python langdetect.py "Bonjour le monde"',
            expect.any(Function),
        );
    });
    ...
    it("should handle execution errors", async () => {
        ...
        await expect(detectEnglish("Test text")).rejects.toThrow(
            "Command failed",
        );
        expect(exec).toHaveBeenCalledWith(
            'python langdetect.py "Test text"',
            expect.any(Function),
        );
    });
