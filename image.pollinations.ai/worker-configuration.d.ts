/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: a6bcb51828a6b1d01ab6262c6ad19514)
// Runtime types generated with workerd@1.20251011.0 2025-09-01 
declare namespace Cloudflare {
	interface Env {
		FEED_PASSWORD: string;
		GPT_IMAGE_1_ENDPOINT: string;
		GPT_IMAGE_1_AZURE_API_KEY: string;
		GPT_IMAGE_2_ENDPOINT: string;
		GPT_IMAGE_2_AZURE_API_KEY: string;
		AZURE_FLUX_KONTEXT_ENDPOINT: string;
		AZURE_FLUX_KONTEXT_API_KEY: string;
		...
		AZURE_SORA_API_KEY: string;
		FLUX_KONTEXT_KEY: string;
		VITE_TEST_REFERRER: string;
		TINYBIRD_API_KEY: string;
		BPAIGEN_PASSWORD: string;
		GOOGLE_APPLICATION_CREDENTIALS: string;
		GCLOUD_PROJECT_ID: string;
		BLOCKED_USERS_GEMINI: string;
		PRIORITY_MODEL_USERS: string;
		CONTAINER: DurableObjectNamespace /* ImageServiceContainer */;
	}
}
