...
if __name__ == "__main__":
    prompt = "a soft lighting portrait photo of a happy young woman with long hair, wearing a white blouse, sitting in a modern cafe with large windows, high resolution, 16:9 aspect ratio"
    seed = 42
