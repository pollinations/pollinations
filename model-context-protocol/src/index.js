...
export async function generateAudio(prompt, options = {}) {
  ...
  try {
    console.log(`Generating audio from URL: ${url}`);
...
export async function listModels(type = "image") {
  try {
    ...
    console.log(`Fetching ${type} models from ${baseUrl}/models`);
