...
/**
 * Sync operations/app-management/app.json → Tinybird app_directory datasource.
 *
 ...
 *
 * Usage: node operations/app-management/sync-to-tinybird.js
 *
 * Env vars:
...
async function main() {
    ...
    console.log(`Parsed ${rows.length} apps from app.json`);
