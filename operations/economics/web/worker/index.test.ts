...
describe("economics Worker auth", () => {
    ...
    it("creates a session after Enter approves dashboard login", async () => {
    ...
    it("does not create a session when Enter denies dashboard login", async () => {
        upstream({ denied: true });
