...
const ConditionsContext = createContext<FlowConditions | null>(null);

export function FlowConditionsProvider({ children }: PropsWithChildren) {
...
export function useFlowConditions() {
    const value = useContext(ConditionsContext);
    if (!value) throw new Error("Flow conditions provider is missing");
    return value;
}
