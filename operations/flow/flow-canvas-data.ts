...
import { dashboardScreens } from "./flow-dashboard";
import { ADMIN_ORIGIN, screenOrigin } from "./local-origins";
...
export function canvasScreenUrl(
    ...
    const origin = screenOrigin(params.get("screen"));
    return `${origin === ADMIN_ORIGIN ? origin : ""}/flow-screen.html?${params}`;
}
