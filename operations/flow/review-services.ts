...
export function createReviewServices() {
    ...
    return {
        ...
        async outbound(request: Request): Promise<Response | undefined> {
            ...
            if (
                url.origin === "https://flow-review.invalid" &&
                request.method === "POST" &&
            ...
            if (
                ...
                return Response.json({
                    ...
                    username: "flow-review",
                    global_name: "Flow review",
            ...
            if (url.origin === "https://api.stripe.com") {
                if (url.pathname === "/v1/customers/cus_flow_review")
                    return Response.json({
                        id: "cus_flow_review",
                        object: "customer",
                        name: "Flow review",
                        ...
                        address: { country: "DE" },
                        invoice_settings: {
                            default_payment_method: "pm_flow_review",
                        },
                    });
                if (url.pathname === "/v1/payment_methods/pm_flow_review")
                    return Response.json({
                        id: "pm_flow_review",
                ...
                if (url.pathname === "/v1/invoices/in_flow_review")
                    return Response.json({
                        id: "in_flow_review",
                        object: "invoice",
                        status: "open",
                        hosted_invoice_url:
                            "https://billing.example.invalid/flow-review",
                    });
            }
            return undefined;
        },
