...
- Image-to-image: Use the 'image' parameter with a model that lists image input support
...
- Reasoning: Call listTextModels and choose a model with the reasoning capability`;
