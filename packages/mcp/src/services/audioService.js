...
async function transcribeAudio(params) {
    ...
    const { audioUrl, ...requestParams } = params;
        ...
        z
            .object({
                ...
                voice: z
                    ...
                    .optional()
                    .describe(
                        "Voice name or provider voice ID; use listModels",
                    ),
                response_format: z
                    .string()
                    .optional()
                    .describe(
                        "Audio format such as mp3, wav, flac, opus, or pcm",
                    ),
            })
            .passthrough(),
        textToSpeech,
        ...
        z
            .object({
                audioUrl: z
                    .string()
                    .url()
                    .describe("Public HTTPS audio file URL"),
                model: z
                    .string()
                    .optional()
