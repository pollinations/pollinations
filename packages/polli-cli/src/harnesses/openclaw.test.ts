...
describe("openclaw harness", () => {
    it("writes the provider, default model, key, and skill from scratch", () => {
        ...
        expect(provider).toMatchObject({
            ...
            // biome-ignore lint/suspicious/noTemplateCurlyInString: this is OpenClaw's own ${VAR} substitution syntax, not a JS template
    ...
    it("keeps existing config, agents, and channels untouched", () => {
        ...
        expect(config.models.providers.openai).toEqual({ apiKey: "sk-openai" });
