...
const claudeCode: McpClient = jsonClient({
    id: "claude-code",
    label: "Claude Code",
    description: "Install Pollinations MCP servers into Claude Code (user scope)",
...
const opencode: McpClient = jsonClient({
    id: "opencode",
    label: "OpenCode",
    description: "Install Pollinations MCP servers into OpenCode (user config).",
...
const vscode: McpClient = jsonClient({
    ...
    description:
        "Install Pollinations MCP servers into the current VS Code workspace (.vscode/mcp.json).",
    restartHint:
