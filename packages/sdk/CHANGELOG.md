...
### Changed
- **BREAKING**: `UsageRecord.cost_usd` and `DailyUsageRecord.cost_usd` renamed to `pollen_spent`. Same value. The field always carried pollen (not USD) — the old name was a misnomer.
