...
describe("Pollinations account earnings", () => {
    it("passes the time window through and returns daily and perEntity as-is", async () => {
        const client = newClient();
        const row = {
            date: "2026-04-14",
        ...
        const payload = { daily: [row], perEntity: [{ ...row, date: "" }] };
