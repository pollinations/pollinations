...
export function AuthModalHeader({ children }: AuthModalHeaderProps) {
    const logo = (
        <a
            ...
            className="polli:block polli:shrink-0 polli:text-app-bg polli:transition-colors polli:hover:text-theme-text-strong polli:focus-visible:outline-2 polli:focus-visible:outline-offset-4"
