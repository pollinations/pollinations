...
const providerButtonClasses: Record<SocialProvider, string> = {
    google: "polli:border-[#dadce0] polli:bg-[#ffffff] polli:text-[#1f1f1f] polli:shadow-[0_1px_2px_rgba(60,64,67,0.18)] polli:hover:border-[#c6c9cc] polli:hover:bg-[#f1f3f4] polli:hover:shadow-[0_1px_3px_rgba(60,64,67,0.30),0_1px_2px_rgba(60,64,67,0.15)] polli:focus-visible:ring-[#4285f4]",
