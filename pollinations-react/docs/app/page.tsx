...
const tabs = [
  {
    value: "text",
    label: "usePollinationsText",
    shortLabel: "Text",
    component: <TextTab />,
  },
  {
    value: "image",
    label: "usePollinationsImage",
    shortLabel: "Image",
    component: <ImageTab />,
  },
  {
    value: "chat",
    label: "usePollinationsChat",
    shortLabel: "Chat",
    component: <ChatTab />,
  },
];
...
export default function PollinationsDemo() {
  ...
  return (
    <div className="container mx-auto p-4 bg-slate-900 text-slate-100 max-w-4xl">
      ...
      <h2 className="text-xl mb-8 text-center text-slate-300">
        This playground is designed to showcase the versatility and hackability
        of the Pollinations API
      </h2>

      <Tabs
        value={activeTab}
        onValueChange={(value) =>
          setActiveTab(value as "text" | "image" | "chat")
        }
        className="w-full"
      >
      ...
      <footer className="mt-8 text-center text-slate-300">
        <p>
          Made with ❤️ by{" "}
          <a className="hover:underline" href="https://pollinations.ai">
            Pollinations.ai
          </a>
          &nbsp;and&nbsp;
          <a
        ...
        <div className="mt-2 flex justify-center space-x-4">
          <a
            href="https://github.com/pollinations/pollinations/pollinations-react"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://discord.com/invite/kuPRYEJS"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-400 hover:text-blue-300"
          >
          ...
          <a
            href="https://chat.whatsapp.com/JxQEn2FKDny0DdwkDuzoQR"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-400 hover:text-blue-300"
          >
