...
import { MOBILE_BREAKPOINT, Colors, Fonts } from "../config/global"
import { Container as ContainerBase, Flex } from "../../config/style"
...
const FeaturedApplicationsContent = [
  {
    ...
    description: (
      <>
        Dive into the world of AI-driven music videos crafted specifically for artists,
        installations, and events. We specialize in creating bespoke videos that bring your artistic
        visions to life.
        <br /> <br />
        Ideal for musicians, event organizers, and visual artists seeking to enhance their projects
        with unique, compelling visuals.
        <br /> <br />
        Let us help you transform your psychedelic ideas into stunning visual narratives.
      </>
    ),
  },
]
...
const MusicVideo = (props) => {
  return (
    <Style>
      ...
      <Container>
        {FeaturedApplicationsContent.map((item, idx) => (
          <FeaturedApp {...item} right={idx % 2} />
        ))}
      </Container>
      {/*<BackgroundImage 
      ...
      <Grid container spacing={4}>
        ...
        <Grid size={gridItemSize}>
          ...
          <iframe
            width="75%"
            height="540"
            src="https://www.youtube-nocookie.com/embed/HXCd1jmlL-g?si=FTz5JLj7FA8-dpZ9&amp;controls=0"
          ...
          <iframe
            width="75%"
            height="540"
            src="https://www.youtube-nocookie.com/embed/k_W8UtOO6vQ?si=dYDFG5nHTrXpGfId&amp;controls=0"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowfullscreen
...
function SlickSlider({ imgs, pad }) {
  ...
  return (
    <Slider {...settings} style={{ width: "100%", padding: pad ? "2.5em" : "0em" }}>
      {imgs.map((img) => (
        <FeatureAppImg key={img} src={img} />
      ))}
    </Slider>
  )
}
