...
export const HERO_CTO_1 = "Talk to us, reach out"
...
export const APPLICATION_TITLE = "User Builds"
export const APPLICATION_SUBTITLE =
  "Here are some of the various implementations that our API is currently powering."

export const APPLICATION_CTO_2 = "Talk to us"
export const APPLICATION_CTO_1 =
  "Have you created a project that integrates Thot? We'd love to feature it!"
...
`
export const DISCORD_SUBTITLE = `
Introduce our Discord channel and incitivate to join, make it just a few words. Don't cite
Discord. In one sentence. Format with emojis. Use italics and bold to make the text more
engaging.
`
export const DISCORD_CTO = `Join our Discord`
