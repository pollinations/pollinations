...
export const IMAGE_FEED_TOOLTIP_WIDTH = "sets the number of pixels in the horizontal direction."

export const IMAGE_FEED_TOOLTIP_HEIGHT = "sets the number of pixels in the vertical direction."
...
export const ASCII_APP_TOOLTIP = "Incite the users to try out our ASCII art generator!"
