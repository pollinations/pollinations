...
export const PROJECT_CTO_2 =
  "Express this in one very very short sentence: Talk to us" + EMOJI_STYLE
...
export const SUPPORTER_SUBTITLE =
  "We're grateful to our supporters for their contributions to our platform." + EMOJI_STYLE
export const SUPPORTER_LOGO_STYLE =
  "minimalist and modern square logo on white background" + EMOJI_STYLE
