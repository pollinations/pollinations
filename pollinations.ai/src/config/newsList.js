export const newsList = `- **2025-03-05** - 🎵 New audio features! Text-to-speech and speech-to-text capabilities are now available with the \`openai-audio\` model. Try it at [text.pollinations.ai](https://text.pollinations.ai/).
