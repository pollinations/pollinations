export const newsList = `- **2025-03-20** - New MCP Server! AI assistants like Claude can now generate images directly using our Model Context Protocol server. [Learn more](https://github.com/pollinations/pollinations/tree/master/mcp).
