export const newsList = `- **2025-03-05** - 🎵 New audio features! Text-to-speech and speech-to-text capabilities are now available with the \`openai-audio\` model. Check the [API Docs](https://github.com/pollinations/pollinations/blob/master/APIDOCS.md).
