...
const allProjects = {
  toolsInterfaces: [
    ...
    },
    {
      ...
      description:
        "A browser-based front-end for AI-assisted writing with multiple local & remote AI models, including integration with Pollinations.AI for image generation.",
      author: "@henk717",
    ...
    },
    {
      ...
      description:
        "AI-powered text and audio content generation platform providing a user-friendly interface for interacting with various AI generation services from Pollinations.ai.",
      author: "@voodoohop",
    ...
    },
    {
      ...
      description:
        "An HTML-based chat interface that leverages Pollinations AI as its core engine for both text and image generation, featuring user authentication, streaming responses, and plan management.",
      author: "@3ch0AI",
    ...
    },
    {
      ...
      description:
        "Enhances the user experience on pollinations.ai pages by improving content readability, adding convenient download options, and providing easy access to generation metadata.",
      author: "@fisven",
    ...
    },
    {
      ...
      description:
        "A web app for coding with vibes, created using Pollinations.AI Open Source API without coding syntax.",
  ...
  llmIntegrations: [
    ...
    },
    {
      ...
      description:
        "An AI-powered REST API designed to generate definitions for words or phrases, constrained to a specified target word count. It allows customization of tone, context, and language, delivering precise, context-aware definitions programmatically—ideal for developers and content creators.",
      author: "@hasanraiyan",
    ...
    },
    {
      ...
      description:
        "A free, open-source browser extension that brings the power of ChatGPT and browser automation directly to your fingertips. Instantly access AI assistance, manage tabs, and organize bookmarks using natural language all securely within your browser.",
      author: "@mkantwala",
    ...
    },
    {
      ...
      description:
        "Create stunning AI-generated images in seconds with our free AI image generator. No login required, unlimited generations, powered by FLUX model.",
    ...
    },
    {
      ...
      description:
        "A snarky bot based on Llama that is 100% free, powered by the Pollinations text API and OpenWebUI. Other models are available as well.",
      author: "@mcgdj",
    ...
    },
    {
      ...
      description:
        "This project provides a free API interface supporting various text and image generation models, including OpenAI's GPT-4, Gemini 2.0, etc. Users can access these models without an API key to perform text generation, image generation, translation, text polishing, and more.",
    ...
    },
    {
      ...
      description:
        "A state-of-the-art chatbot integrating multiple LLMs with advanced features including audio generation, image generation, mathematical proficiency, and real-time web search.",
      author: "@withthatway",
    ...
    },
    {
      ...
      description:
        "An open-source, modern-design ChatGPT/LLMs UI/Framework with speech-synthesis, multi-modal, and extensible plugin system.",
  ...
  creativeApps: [
    ...
    },
    {
      ...
      description:
        "A web application that utilizes Pollinations.AI API to generate images based on user-defined descriptions, with features like prompt enhancement, customizable image settings, and image download.",
    ...
    },
    {
      ...
      description:
        "An AI image generator that creates unique images from text prompts. Fast, easy and free!",
      author: "@metimol",
      submissionDate: "2025-04-19",
      order: 1,
    },
    ...
    },
    {
      ...
      description:
        "A collection of tools to help Growers, Breeders & Seed Bankers. Free & Open Source powered by Pollinations.ai.",
      author: "@Tolerable",
    ...
    },
    {
      ...
      description:
        "A free and fun platform for creating unique AI-generated images. No fancy skills needed – just your ideas and a few clicks to bring them to life. Features image generation, text-to-prompt conversion, and image-to-text capabilities.",
      author: "@enciksnow",
    ...
    },
    {
      ...
      description:
        "A Web interface to create thematic images from prompts, with multiple aspect ratios and also image reference inputs.",
    ...
    },
    {
      ...
      description:
        "输入文本，选择语音风格，一键将文字转换为自然流畅的语音。 支持多种声音特征，帮您创建专业水准的音频内容。 (Input text, select voice style, and instantly convert text to natural, fluid speech. Supports various voice characteristics to help you create professional-quality audio content.)",
    ...
    },
    {
      name: "🆕 Case Me 🇧🇷",
      description:
        "O projeto consiste em uma vending machine que criará capinhas para celular personalizadas com fotos ou outras imagens e cores de escolha do cliente final. (A vending machine that creates customized phone cases with photos or other images and colors chosen by the end customer.)",
    ...
    },
    {
      ...
      description:
        "Roblox game where you can talk with AI catgirls 🐾 or just have fun, talking with other players in cozy rooms ⭐️",
    ...
    },
    {
      ...
      description:
        "Jenny AI is an AI chatbot and character creation platform with tts and sst it also has image generation and vision ability which are powered by pollinations.",
    ...
    },
    {
      ...
      description:
        "An AI-powered roast generator that allows users to upload selfies for savage AI-generated roasts, enter text for brutal critiques, or engage in roast battles. Images are processed securely on the device, protecting user privacy.",
      author: "@sugamdeol",
    ...
    },
    {
      ...
      description:
        "AI Personality Analyzer - Get roasted and psychoanalyzed.. just from one selfie! Dare to try?",
      author: "@andres_11",
      submissionDate: "2025-03-14",
      order: 2,
    },
    {
      ...
      description:
        "An interactive web application designed to create engaging and customizable stories for children. Users can generate creative narratives with personalized settings, characters, and themes. The project leverages AI to enhance storytelling with text generation, dynamic visuals, and interactive features.",
    ...
    },
    {
      ...
      description:
        "An AI-powered image generation platform for Android designed to create stunning visuals from text prompts. Features dynamic image generation as users scroll, save to gallery, favorites, and a user-friendly interface.",
    ...
    },
    {
      ...
      description:
        "Musify is your AI-powered music buddy, making your jam sessions smarter and more fun. It is powered by pollinations api, it offers a slick and intuitive music experience with features like AI Music Assistant, Voice Commands, AI Playlist Creator, and Responsive Design.",
      author: "@Sugamdeol",
    ...
    },
    {
      ...
      description:
        "A web-based AI image generator powered by Pollinations.ai, featuring multi-model support, customizable parameters, and real-time preview.",
      author: "@hrisjeui",
    ...
    },
    {
      ...
      description:
        "An AI-driven tool that transforms text prompts using MidiJourney into MIDI-based melodies through browser oscillators.",
      author: "@brain.diver",
    ...
    },
    {
      ...
      description:
        "A web-based generative interactive fiction (text adventure) set in a sci-fi underwater world.",
      author: "@brain.diver",
  ...
  toolsInterfaces: [
    ...
    },
    {
      name: "🆕 DominiSigns",
      description:
        "Avatar Translator for Dominican Sign Language that uses artificial intelligence to translate text and audio into Dominican sign language (LSRD), creating a communication bridge for approximately 100,000 deaf people in the Dominican Republic.",
      author: "@cmunozdev",
    ...
    },
    {
      ...
      description:
        "A custom WordPress Gutenberg block that allows you to generate images using the Pollinations API. Simply enter a prompt, and the AI will generate an image for you. Once the post is saved, the image is automatically stored in the WordPress Media Library.",
    ...
    },
    {
      ...
      url: "https://toai.chat",
      description:
        "An AI chat service that operates exclusively via Curl commands, specifically designed for users working in terminal environments without the need for a standalone AI client.",
    ...
    },
    {
      ...
      description:
        "Builds a bentro grid UI which integrates with the pollinations realtime SSE feed to show case art generation, with virtual DOM update to reduce lag and optimization.",
      author: "Ayushman Bhattacharya",
      repo: "https://github.com/Circuit-Overtime/elixpo_ai_chapter",
      stars: 8,
      submissionDate: "2025-03-14",
    ...
    },
    {
      ...
      description:
        "Create professional-quality anime characters with powerful AI technology. No artistic skills required.",
  ...
  socialBots: [
    ...
    },
    {
      ...
      description:
        "A Discord multi-purpose bot with over 100+ commands, including AI image generation, ChatGPT, and SearchGPT powered by Pollinations.AI.",
    ...
    },
    {
      ...
      description:
        "Discord bot that uses several APIs (Pollinations AI and Cerebras AI), to offer a variety of features, including advanced text generation with a history of your conversations, image and voice generation.",
    ...
    },
    {
      ...
      description:
        "A Telegram bot deployed on Cloudflare Workers that allows users to generate images, convert text to speech, transcribe voice messages, chat with AI models, and more through the Pollinations API.",
      author: "@Shadownc",
    ...
    },
    {
      ...
      description:
        "A Discord Bot that integrates with the pollination image generation api to generate images in various themes, numbers, ratios and models",
      author: "@elixpo.asm",
      submissionDate: "2025-03-15",
      order: 1,
    },
    {
      ...
      description:
        "A versatile AI chat-bot and image generator powered by Pollinations.AI, featuring web search, image generation with model selection, and character-aware image generation through !webgen command.",
      author: "@_dr_misterio_",
    ...
    },
    {
      ...
      description:
        "A Telegram bot for a word-matching game where players try to write the same word simultaneously, featuring image generation from game words using Pollinations.AI.",
      author: "@Dimaq21",
      submissionDate: "2025-02-17",
      order: 4,
    },
    {
      ...
      description:
        "Free Telegram bot providing access to neural networks including image and text generation powered by Pollinations.AI",
  ...
  sdkLibraries: [
    {
      ...
      description:
        'A fork of the original task master but uses pollinations instead to be used for free. Has both a CLI and MCP and distributed as an npm package now as "pollinations-taskmaster".',
      author: "@LousyBook94",
    ...
    },
    {
      ...
      description:
        "An open-source AI pipeline framework designed to simplify the integration and orchestration of various AI models and services. The platform provides a modular architecture that allows developers to easily build, test, and deploy AI-powered applications with support for Pollinations.ai as a provider.",
    ...
    },
    {
      ...
      description:
        "A custom node for ComfyUI that utilizes the Pollinations API to generate images and text based on user prompts, supporting multiple image and text generation models.",
    ...
    },
    {
      ...
      description:
        "A TypeScript/Node.js client for accessing Pollinations AI services including image generation, text processing, and speech synthesis. Features full TypeScript typings, dual CJS/ESM module support, 100% test coverage and feed/streams support, builder pattern API and axios-based HTTP client implementation.",
      author: "@fqueis",
    ...
    },
    {
      ...
      description:
        "A Flutter/Dart SDK package for accessing all features of pollinations.ai including text generation, image generation, audio, and listing all supported models.",
      author: "@Meenapintu",
  ...
  tutorials: [
    ...
    },
    {
      ...
      description:
        "How to add Pollinations AI Text Models to OpenWebUI for free access to top language models like GPT-4o, Mistral, Claude, and Gemini without signups or API keys.",
      author: "@cloph-dsp",
    ...
    },
    {
      ...
      description:
        "A tutorial showing how to make DeepSeek AI support image generation by leveraging Pollinations.ai's API.",
...
const organizeFeaturedProjects = (sourceProjects) => {
  ...
  Object.keys(sourceProjects).forEach((category) => {
    ...
    const featuredProjectNames = new Set(
      order1Projects.map((project) => project.name.replace("🆕", "").trim())
    )
