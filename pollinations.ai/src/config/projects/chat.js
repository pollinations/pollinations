...
export const chatProjects = [
...

	{
		...
		description:
			"A privacy-focused chat assistant app that securely stores data locally, integrates with PollinationAI for text and image generation, features a minimalistic UI, and allows users to choose models and write their own system instructions.",
	...
	},
	{
		...
		description:
			"Lightweight and simple online chat interface powered by pollinations",
		author: "@thatalgp",
	...
	},
	{
		...
		url: "https://toai.chat/",
		description:
			"A personalized, multimodal AI chat assistant that leverages Pollinations APIs to converse with models like Claude, provide image generation, and answer questions about various topics.",
		author: "@arjunbazinga",
	...
	// Duplicate entry consolidated with the other Irina entry
	{
		...
		description:
			"An intelligent conversational assistant that combines Pollinations' text and image generation capabilities to create rich, multimedia responses to user queries.",
		author: "@visuallink",
	...
	},
	{
		...
		description:
			"An advanced chatbot leveraging multiple GPT models via Pollinations for sophisticated dialogue management, context retention, and multimodal interactions. Includes features like personality selection and knowledge base integration.",
