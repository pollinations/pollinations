...
export const creativeProjects = [
	...
	},
	{
		...
		description:
			"An image generator powered by pollinations.ai and its image generation models. Features text-to-image generation with various AI models.",
		author: "@mregon",
	...
	},
	{
		...
		description:
			"Musify is your AI-powered music buddy, making your jam sessions smarter and more fun. Powered by pollinations API, it offers AI Music Assistant, Voice Commands, AI Playlist Creator, and Responsive Design.",
		author: "@Sugamdeol",
	...
	},
	{
		name: "Case Me 🇧🇷",
		description:
			"A vending machine that creates customized phone cases with photos or other images and colors chosen by the end customer.",
	...
	},
	{
		...
		description:
			"Text-to-image generator using Pollinations, supporting Indonesian and English prompts.",
		author: "@ayick13",
	...
	},
	{
		...
		description:
			"AI tool that generates HTML websites with visuals from Pollinations.",
		author: "@logise",
		submissionDate: "2025-04-30",
		order: 1,
	},
	...
	},
	{
		...
		description:
			"A free AI image generation website with a clean and professional interface, offering high-quality image generation without requiring API keys.",
	...
	},
	{
		...
		description:
			"文生图与文生语音网站 - 一个初学者的AI编程项目，支持文本转图像和音频生成功能。(Text to Image and Text to Audio website - A beginner's AI programming project supporting text-to-image and audio generation features.)",
		author: "@peyoba",
	...
	},
	{
		...
		description:
			"A social media inspired application for browsing, creating, and sharing AI-generated images using the Pollinations API.",
		author: "@yujincs",
	...
	},
	{
		...
		description:
			"A web app specializing in anime-style image generation using Pollinations AI, with options for different anime art styles and character designs.",
	...
	},
	{
		...
		url: "https://memed.io",
		description:
			"An AI-powered meme generator that creates humorous images based on user prompts using Pollinations API for image generation.",
		author: "@k_singh",
	...
	},
	{
		...
		description:
			"A tool that uses Pollinations AI to generate engaging YouTube Shorts videos from text prompts, including visuals and voiceovers.",
	...
	},
	{
		...
		description:
			"A Chinese language AI image generation platform using Pollinations, tailored for creating artistic and culturally relevant visuals.",
		author: "@jolav_cn",
		language: "zh",
		submissionDate: "2025-05-02",
		order: 2,
	},
	{
		...
		description:
			"A platform for creating and sharing AI-generated art, music, and stories, with a strong community focus and Pollinations integration.",
	...
	},
	{
		...
		description:
			"An AI music generation tool that creates MIDI compositions from text prompts using Pollinations, suitable for musicians and producers.",
		author: "@midi_maestro",
		submissionDate: "2025-04-15",
		order: 1,
	},
	...
	},
	{
		...
		description:
			"An AI image generation tool specializing in traditional Indian art styles, using Pollinations to create culturally rich visuals.",
		author: "@rangrez_art",
		language: "hi",
		submissionDate: "2025-04-28",
		order: 2,
	...
	},
	{
		...
		description:
			"An AI-powered platform for collaborative storytelling, where users can co-create narratives with AI using Pollinations for text and image generation.",
		author: "@weave_tales",
		submissionDate: "2025-04-22",
		order: 1,
	},
	{
		...
		description:
			"A curated gallery of AI-generated images created with Pollinations, showcasing diverse styles and themes from the community.",
	...
	},
	{
		...
		description:
			"A dynamic gallery showcasing AI-generated art created with Pollinations. Users can browse, search, and filter images, and submit their own creations. Features community voting and artist profiles.",
		author: "@gallery_ai",
	...
	},
	{
		...
		description:
			"A platform for generating and exploring AI-created floral art and patterns. Users can customize flower types, colors, and arrangements using Pollinations, and share their digital bouquets.",
		author: "@bloom_artist",
		submissionDate: "2025-04-30",
		order: 2,
	},
	{
		...
		description:
			"Jackey is a creative AI companion that helps users generate story ideas, write scripts, and create concept art using Pollinations. It's designed for writers, game developers, and filmmakers.",
