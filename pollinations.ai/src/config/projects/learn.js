...
export const learnProjects = [
    {
        ...
        description:
            "AI-powered geography insights using text.pollinations.ai API. Click anywhere on the map to discover cultural insights, historical facts, and local knowledge. Features smart route planning with flight and car routes, AI-assisted travel planning, and interactive exploration of locations worldwide.",
        author: "@argyrisAEK",
    ...
    },
    {
        ...
        description:
            "Dynamic platform for organizing, curating, and sharing effective AI prompts. Massive library of ready-to-use prompts for text, image, video, and code generation. Uses Pollinations.ai for generating prompts and thumbnails. Community-driven with search, filter tools, and daily updates.",
        author: "@pickplugins",
    ...
    },
    {
        ...
        "description":
            "Django app for mastering foreign vocabulary with AI-powered features. Create bilingual dictionaries with translations, example sentences, IPA pronunciation, text-to-speech audio, and flashcard learning. Supports multiple interface languages.",
        "author": "@rudotcom",
    ...
    {
        name: "🤖 Discord Bot Tutorial",
        url: "https://gist.github.com/Tolerable/9908e626147689fe72cdab8f2e1e6743",
        description:
            "Comprehensive tutorial for building Discord bots with Pollinations.ai. Covers text generation with conversation context, image generation with Flux model, voice/TTS generation, error handling, rate limiting, and best practices. ~1000 lines of working Python code.",
        author: "@Tolerable",
