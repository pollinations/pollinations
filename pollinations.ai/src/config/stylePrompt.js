...
export const getDefaultPrompt = (text, isWhiteBG = true) => {
  const foregroundColor =
    typeof isWhiteBG === "string" ? isWhiteBG : isWhiteBG ? Colors.offwhite : Colors.offblack
  const backgroundColor =
    typeof isWhiteBG === "string" ? Colors.offblack : isWhiteBG ? Colors.offblack : Colors.offwhite
