    ...
    "inline-flex items-center justify-center transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 rounded-button",
    {
        variants: {
            variant: {
                ...
                "toggle-glow":
                    "px-3 py-1.5 font-headline uppercase tracking-wider text-xs border-2 transition-all data-[active=true]:bg-[rgb(var(--glow)_/_0.15)] data-[active=true]:border-[rgb(var(--glow))] data-[active=true]:text-[rgb(var(--glow))] data-[active=true]:font-black data-[active=true]:shadow-[0_0_10px_rgb(var(--glow)_/_0.4)] data-[active=false]:bg-white data-[active=false]:border-tan data-[active=false]:text-[rgb(var(--glow)_/_0.6)] data-[active=false]:hover:border-[rgb(var(--glow)_/_0.6)] data-[active=false]:hover:text-[rgb(var(--glow))] data-[active=false]:hover:shadow-[0_0_6px_rgb(var(--glow)_/_0.25)]",
                // Copy button (small, white bg, dark border)
                copy: "px-4 py-2 font-headline uppercase text-xs font-black text-dark bg-white border-2 border-dark hover:shadow-dark-sm transition-all",
                // Model selector (tiny, 4-state logic) - PlayPage model buttons
                model: "relative px-2 py-1.5 font-mono text-base font-medium text-dark transition-all data-[active=true]:text-white data-[active=true]:data-[type=image]:bg-primary-light data-[active=true]:data-[type=image]:shadow-dark-sm data-[active=true]:data-[type=text]:bg-secondary-light data-[active=true]:data-[type=text]:shadow-dark-sm data-[active=true]:data-[type=audio]:bg-tertiary-light data-[active=true]:data-[type=audio]:shadow-dark-sm data-[active=true]:data-[type=video]:bg-accent-strong data-[active=true]:data-[type=video]:shadow-dark-sm data-[active=false]:bg-white data-[active=false]:data-[type=image]:hover:bg-white data-[active=false]:data-[type=text]:hover:bg-white data-[active=false]:data-[type=audio]:hover:bg-white data-[active=false]:data-[type=video]:hover:bg-white",
                // Generate button (full-width, dynamic color) - PlayPage generate button
                generate:
                    "w-full px-6 py-4 font-headline uppercase text-sm font-black text-white border-r-4 border-b-4 border-dark transition-all data-[type=image]:bg-primary-light data-[type=image]:shadow-dark-md data-[type=image]:hover:translate-x-[2px] data-[type=image]:hover:translate-y-[2px] data-[type=image]:hover:shadow-dark-sm data-[type=text]:bg-secondary-light data-[type=text]:shadow-dark-md data-[type=text]:hover:translate-x-[2px] data-[type=text]:hover:translate-y-[2px] data-[type=text]:hover:shadow-dark-sm data-[type=audio]:bg-tertiary-light data-[type=audio]:shadow-dark-md data-[type=audio]:hover:translate-x-[2px] data-[type=audio]:hover:translate-y-[2px] data-[type=audio]:hover:shadow-dark-sm data-[type=video]:bg-accent-strong data-[type=video]:shadow-dark-md data-[type=video]:hover:translate-x-[2px] data-[type=video]:hover:translate-y-[2px] data-[type=video]:hover:shadow-dark-sm disabled:opacity-50 disabled:cursor-not-allowed enabled:cursor-pointer",
                // Icon button (header social icons) - Square, responsive size
                icon: "flex-shrink-0 w-6 h-6 lg:w-8 lg:h-8 flex items-center justify-center bg-white border-r-4 border-b-4 border-dark shadow-dark-sm hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all p-1 lg:p-1.5",
                // Icon with text button (Enter button) - Matches nav button padding
                iconText:
                    "flex-shrink-0 px-3 py-1.5 flex items-center justify-center gap-1 bg-white text-dark border-r-4 border-b-4 border-dark shadow-dark-sm hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all",
