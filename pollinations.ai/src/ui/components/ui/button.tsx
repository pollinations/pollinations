    ...
    "inline-flex items-center justify-center transition focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 rounded-button",
    {
        variants: {
            variant: {
                ...
                model: "relative px-2 py-1.5 font-mono text-base font-medium text-dark transition whitespace-normal break-words data-[active=true]:bg-white data-[active=true]:text-dark data-[active=true]:font-black data-[active=true]:border-r-4 data-[active=true]:border-b-4 data-[active=true]:data-[type=image]:border-primary-strong data-[active=true]:data-[type=image]:shadow-[3px_3px_0_rgb(var(--primary-strong))] data-[active=true]:data-[type=text]:border-secondary-strong data-[active=true]:data-[type=text]:shadow-[3px_3px_0_rgb(var(--secondary-strong))] data-[active=true]:data-[type=audio]:border-tertiary-strong data-[active=true]:data-[type=audio]:shadow-[3px_3px_0_rgb(var(--tertiary-strong))] data-[active=true]:data-[type=video]:border-accent-strong data-[active=true]:data-[type=video]:shadow-[3px_3px_0_rgb(var(--accent-strong))] data-[active=false]:data-[type=image]:bg-primary-light/40 data-[active=false]:data-[type=text]:bg-secondary-light/40 data-[active=false]:data-[type=audio]:bg-tertiary-light/40 data-[active=false]:data-[type=video]:bg-accent-strong/30 data-[active=false]:hover:data-[type=image]:bg-primary-light/70 data-[active=false]:hover:data-[type=text]:bg-secondary-light/70 data-[active=false]:hover:data-[type=audio]:bg-tertiary-light/70 data-[active=false]:hover:data-[type=video]:bg-accent-strong/50",
