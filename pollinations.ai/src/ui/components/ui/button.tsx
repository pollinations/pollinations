    ...
    "inline-flex items-center justify-center transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 rounded-button",
    {
        variants: {
            variant: {
                ...
                model: "relative px-2 py-1.5 font-mono text-sm font-medium text-text-body-main transition-all data-[active=true]:text-text-on-color data-[active=true]:data-[type=image]:bg-indicator-image data-[active=true]:data-[type=image]:shadow-shadow-dark-sm data-[active=true]:data-[type=text]:bg-indicator-text data-[active=true]:data-[type=text]:shadow-shadow-dark-sm data-[active=true]:data-[type=audio]:bg-indicator-audio data-[active=true]:data-[type=audio]:shadow-shadow-dark-sm data-[active=true]:data-[type=video]:bg-indicator-video data-[active=true]:data-[type=video]:shadow-shadow-dark-sm data-[active=false]:bg-input-background data-[active=false]:data-[type=image]:hover:bg-input-background data-[active=false]:data-[type=text]:hover:bg-input-background data-[active=false]:data-[type=audio]:hover:bg-input-background data-[active=false]:data-[type=video]:hover:bg-input-background",
