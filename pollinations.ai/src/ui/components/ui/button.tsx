    ...
    "inline-flex items-center justify-center transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 rounded-button",
    {
        variants: {
            variant: {
                ...
                primary:
                    "gap-2 font-headline uppercase tracking-wider font-black bg-button-primary-bg border-r-4 border-b-4 border-border-strong shadow-shadow-dark-md text-text-on-color hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-shadow-dark-sm active:translate-x-[3px] active:translate-y-[3px] active:shadow-none",
                ...
                copy: "px-4 py-2 font-headline uppercase text-xs font-black text-text-body-main bg-button-secondary-bg border-2 border-border-strong hover:shadow-shadow-dark-sm transition-all",
                ...
                nav: "px-3 py-1.5 lg:px-4 lg:py-2.5 font-headline text-xs lg:text-sm font-black uppercase tracking-wider border-r-4 border-b-4 transition-all duration-200 whitespace-nowrap active:translate-x-[2px] active:translate-y-[2px] active:shadow-none data-[active=true]:border-border-strong data-[active=true]:bg-button-primary-bg data-[active=true]:text-text-on-color data-[active=true]:shadow-shadow-dark-md data-[active=false]:border-border-main data-[active=false]:bg-input-background data-[active=false]:text-text-body-main data-[active=false]:shadow-shadow-dark-sm data-[active=false]:hover:border-border-strong data-[active=false]:hover:bg-button-primary-bg data-[active=false]:hover:text-text-on-color data-[active=false]:hover:shadow-shadow-dark-md data-[active=false]:hover:translate-x-[-1px] data-[active=false]:hover:translate-y-[-1px]",
            },
            size: {
