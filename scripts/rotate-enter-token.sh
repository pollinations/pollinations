...
echo ""
log "Reminder: The following were updated via local files (commit required):"
echo "  - enter.pollinations.ai/secrets/*.vars.json (sops)"
echo "  - image.pollinations.ai/secrets/env.json (sops)"
echo "  - text.pollinations.ai/secrets/env.json (sops)"
echo "  - image.pollinations.ai/.env"
echo "  - text.pollinations.ai/.env"
echo "  - image.pollinations.ai/z-image/setup-ionet.sh"
