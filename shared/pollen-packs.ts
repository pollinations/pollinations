...
// `amountUsd` is the nominal pack size: 1 pollen ≈ $1 before discounts. The
// buyer always receives `amountUsd` pollen (round numbers); larger packs are
// cheaper per pollen via `discountPercent`, which lowers the charged price.
