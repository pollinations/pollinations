...
const IMAGE_BASE_SERVICES = {
    ...
    "seedance-2.0": {
        ...
        title: "Seedance 2.0",
        description:
            "720p video with natively synced sound, from text, images, or reference images",
        inputModalities: ["text", "image"],
    ...
    "seedance-2.5": {
        ...
        title: "Seedance 2.5",
        description:
            "Four-second video with synchronized audio, first/last-frame control, or reference images at 480p or 720p",
        inputModalities: ["text", "image"],
        outputModalities: ["video", "audio"],
        videoCapabilities: [
            "start_frame",
        ...
        maxReferenceImages: 32, // 30 reference images + 2 frame slots (per Replicate schema).
        minDuration: 4,
        maxDuration: 4,
        defaultDuration: 4,
    },
