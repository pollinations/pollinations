...
export const IMAGE_SERVICES = {
    ...
    "wan-pro-1080p": {
        ...
        priceMultiplier: 1,
        paidOnly: true,
        // Replicate wan-2.7 locked to 1080p: t2v is $0.10/s and i2v is
        // $0.15/s. Audio is bundled into the per-second rate.
        cost: {
            completionVideoSeconds: 0.1, // per sec (1080p t2v, includes audio)
        },
        ...defineCostVariants(
            {
                image_to_video: {
                    completionVideoSeconds: 0.15, // per sec (1080p i2v)
                },
            },
            ({ input }) => (input?.hasImage ? "image_to_video" : undefined),
        ),
        title: "Wan 2.7 1080p",
