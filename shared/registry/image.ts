...
export const IMAGE_SERVICES = {
    ...
    "bytedance/seedream-5-pro": {
        aliases: ["seedream-5-pro", "seedream5-pro", "seedream-pro-5"],
    ...
    "bytedance/seedream-4.5": {
        aliases: ["seedream-4.5", "seedream-pro"],
    ...
    "openai/gpt-image-1-mini": {
        aliases: ["gpt-image-1-mini", "gptimage", "gpt-image"],
        modelId: "gptimage",
        provider: "azure",
        brand: "OpenAI",
        category: "image",
    ...
    "openai/gpt-image-1.5": {
        aliases: ["gpt-image-1.5", "gptimage-large", "gpt-image-large"],
    ...
    "tongyi-mai/z-image-turbo": {
        aliases: ["z-image-turbo", "zimage", "z-image"],
        modelId: "zimage",
        provider: "runpod",
        brand: "Alibaba",
        category: "image",
    ...
    "google/veo-3.1-fast": {
        aliases: ["veo-3.1-fast", "veo", "veo-720p", "video"],
        modelId: "veo",
        provider: "google",
        brand: "Google",
        category: "video",
    ...
    "alibaba/wan-2.6": {
        aliases: ["wan-2.6", "wan", "wan2.6", "wan-i2v"],
        modelId: "wan",
        provider: "replicate",
        brand: "Alibaba",
        category: "video",
    ...
    "alibaba/wan-2.2": {
        aliases: ["wan-2.2", "wan-fast", "wan2.2"],
        modelId: "wan-fast",
        provider: "replicate",
        brand: "Alibaba",
        category: "video",
    ...
    "alibaba/wan-2.7": {
        aliases: ["wan-2.7", "wan-pro", "wan2.7"],
        modelId: "wan-pro",
        provider: "replicate",
        brand: "Alibaba",
        category: "video",
    ...
    "alibaba/wan-2.7-image": {
        aliases: ["wan-2.7-image", "wan-image", "wan2.7-image", "wan-img"],
        modelId: "wan-image",
        provider: "replicate",
        brand: "Alibaba",
        category: "image",
    ...
    "lightricks/ltx-2.3": {
        aliases: ["ltx-2.3", "ltx-2", "ltx2", "ltxvideo", "ltx-video"],
        modelId: "ltx-2",
        provider: "lambda",
        brand: "Lightricks",
        category: "video",
