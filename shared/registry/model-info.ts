...
export const ModelInfoSchema = z.object({
    ...
    max_input_references: z.number().int().positive().optional(),
    max_reference_audios: z.number().int().positive().optional(),
...
export function modelInfoFromDefinition(
    ...
    return {
        ...
        max_input_references: service.maxInputReferences,
        max_reference_audios: service.maxReferenceAudios,
