...
export const ModelInfoSchema = z.object({
    ...
    max_input_reference_images: z.number().int().positive().optional(),
    max_input_reference_videos: z.number().int().positive().optional(),
    max_input_reference_audios: z.number().int().positive().optional(),
...
export function modelInfoFromDefinition(
    ...
    return {
        ...
        max_input_reference_images: service.maxInputReferenceImages,
        max_input_reference_videos: service.maxInputReferenceVideos,
        max_input_reference_audios: service.maxInputReferenceAudios,
