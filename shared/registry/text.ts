...
const TEXT_BASE_SERVICES = {
    ...
    "microsoft/mai-thinking-1": {
        supportedParameters: CHAT_PARAMETERS.azureMaiThinking,
        aliases: [],
        provider: "azure",
        publisher: "Microsoft",
        category: "text",
        ...
        cost: {
            promptTextTokens: perMillion(2),
            promptCachedTokens: perMillion(0.2),
            promptCacheWriteTokens: perMillion(2),
            completionTextTokens: perMillion(8),
        },
        title: "MAI Thinking 1",
        description:
            "Long-context reasoning for coding, math, and tool-driven tasks",
        inputModalities: ["text"],
        outputModalities: ["text"],
        tools: true,
        reasoning: true,
