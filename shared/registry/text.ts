...
export const TEXT_SERVICES = {
    ...
    "gpt-oss": {
        ...
        brand: "OpenAI",
        category: "text",
        addedDate: new Date("2026-01-04").getTime(),
        priceMultiplier: 0,
        cost: {
            promptTextTokens: perMillion(0.044),
            completionTextTokens: perMillion(0.165),
        },
        title: "GPT-OSS 20B",
        description: "GPT-OSS 20B - Open-weight reasoning model",
