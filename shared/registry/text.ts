...
export const TEXT_SERVICES = {
    ...
    "llama": {
        ...
        description: "Meta Llama 3.3 70B Instruct via Azure",
        inputModalities: ["text"],
        outputModalities: ["text"],
        tools: true,
        contextLength: 131072,
    ...
    "llama-maverick": {
        ...
        description: "Meta Llama 4 Maverick 17B 128E Instruct via Azure",
        inputModalities: ["text", "image"],
        outputModalities: ["text"],
        tools: true,
        contextLength: 1048576,
        ...
        cost: [
            {
                ...
                promptTextTokens: perMillion(0.16),
                completionTextTokens: perMillion(0.64),
            },
        ],
        description: "Meta Llama 4 Scout 17B 16E Instruct via Azure",
        inputModalities: ["text", "image"],
        outputModalities: ["text"],
        tools: false,
