...
export const TEXT_SERVICES = {
    ...
    "midijourney-large": {
        ...
        // Same Azure gpt-5.5 deployment as openai-large, so the verified
        // GPT-5.5 long-context meters ($10/$1/$45 >272k) apply here too.
        ...defineCostVariants(
            {
                long_context: {
                    promptTextTokens: perMillion(10.0),
    ...
    "gemini-large": {
        ...
        // OpenRouter's Google endpoints apply this whole-request override
        // above 200K prompt tokens. Fields absent from the override keep their
        // base rates; cache storage and search remain adjustments below.
        ...defineCostVariants(
            {
                long_context: {
