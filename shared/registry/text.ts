...
const TEXT_BASE_SERVICES = {
    ...
    "inclusionai/ling-3.0-flash-vl": {
        ...
        cost: {
            ...
            // one prompt rate with no separate image/video rates: image and
            // video parts are tokenized into the prompt total. The route may
            // still report prompt_tokens_details.video_tokens; pricing it at
            // the same prompt rate keeps the billing event exact either way.
