...
export const TEXT_SERVICES = {
    ...
    "gpt-5.6-sol": {
        ...
        description: "ChatGPT 5.6 Sol - Frontier reasoning",
        inputModalities: ["text", "image"],
        outputModalities: ["text"],
    ...
    "gpt-5.6-terra": {
        ...
        description: "ChatGPT 5.6 Terra - Balanced reasoning",
        inputModalities: ["text", "image"],
        outputModalities: ["text"],
        maxReferenceImages: 10,
        tools: true,
    ...
    "gpt-5.6-luna": {
        ...
        description: "ChatGPT 5.6 Luna - Fast low-cost reasoning",
        inputModalities: ["text", "image"],
        outputModalities: ["text"],
        maxReferenceImages: 10,
        tools: true,
    ...
    "grok-4.5": {
        ...
        title: "Grok 4.5",
        description: "Grok 4.5 - xAI flagship reasoning",
        inputModalities: ["text", "image"],
        outputModalities: ["text"],
