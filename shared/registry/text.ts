...
const TEXT_BASE_SERVICES = {
    ...
    "inclusionai/ling-3.0-flash-vl": {
        ...
        cost: {
            ...
            // the mandatory 5.5% OpenRouter credit fee.
            promptTextTokens: perMillion(0.06) * 1.055,
            promptCachedTokens: perMillion(0.012) * 1.055,
            // The prompt rate also prices video: routes that report
            // `prompt_tokens_details.video_tokens` separately bill it here,
            // and routes that fold video into the prompt total bill it as
            // prompt tokens. Registering the rate keeps either convention
            // priced instead of dropping the split into an unrated bucket.
