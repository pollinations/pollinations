...
export const TEXT_SERVICES = {
    ...
    "nemotron-3-ultra": {
        aliases: ["nemotron-3-ultra-120b", "nemotron-3-super", "nvidia-nemotron-3-ultra"],
        modelId: "nvidia/nemotron-3-super-120b-a12b-fp8",
        provider: "nvidia-nim",
        brand: "NVIDIA",
        category: "text",
        addedDate: new Date("2026-07-14").getTime(),
        priceMultiplier: 0,
        cost: {
            promptTextTokens: perMillion(0),
            completionTextTokens: perMillion(0),
        ...
        description: "NVIDIA Nemotron 3 Ultra (120B) - Advanced reasoning model via NVIDIA NIM free tier",
        inputModalities: ["text"],
        outputModalities: ["text"],
        tools: true,
        reasoning: true,
