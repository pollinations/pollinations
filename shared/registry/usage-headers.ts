...
/**
 * Helper for audio transcription (Whisper): create TokenUsage with audio seconds
 * Used for duration-based billing (e.g., OVH Whisper at €0.00004083/sec)
 */
export function createAudioSecondsUsage(
