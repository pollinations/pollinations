...
| **Daily platform images** | `generate_daily_summary.py` | Tier 2 (00:00 UTC) | Brand pixel art (from `brand_visual.md`) | 1 Twitter + 1 LinkedIn + 3 Instagram + 1 Reddit = **6 per day** | Twitter, LinkedIn, Instagram, Reddit daily posts |
| **Weekly platform images** | `generate_weekly_summary.py` | Tier 3 (Sunday 00:00 UTC) | Brand pixel art (from `brand_visual.md`) | 1 Twitter + 1 LinkedIn + 3 Instagram + 1 Reddit = **6 per week** | Twitter, LinkedIn, Instagram, Reddit weekly posts |
