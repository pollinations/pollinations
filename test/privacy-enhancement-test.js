...
function testIPPrivacyEnhancement() {
    ...
    const unauthenticatedRequest = createNexAdRequest(mockReq, mockMessages, mockContent, null);
    console.log('✅ IP included:', unauthenticatedRequest.visitorData.hasOwnProperty('ip'));
    ...
    const authenticatedRequest = createNexAdRequest(mockReq, mockMessages, mockContent, authenticatedUserId);
    console.log('✅ IP included:', authenticatedRequest.visitorData.hasOwnProperty('ip'));
    console.log('   IP value:', authenticatedRequest.visitorData.ip || 'NOT SENT (privacy protected)');
...
function runTests() {
    ...
    console.log('Issue #2667: Disable IP Address Sending to nex.ad for Token-Authenticated Users\n');
    ...
    console.log('  ✅ Authenticated users: IP NOT sent to nex.ad (privacy protected)');
    console.log('  ✅ Authenticated users: Impression URLs NOT fired (privacy protected)');
    console.log('  ✅ Unauthenticated users: Normal geo-targeting functionality maintained');
    console.log('  ✅ Enhanced analytics with user data and privacy indicators');
