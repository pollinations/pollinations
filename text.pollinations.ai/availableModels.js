...
const models = [
  ...
  },
  {
    ...
    handler: generateTextPortkey,
    //    details:  "Advanced model with enhanced performance for sophisticated text, image, and audio tasks.",
    provider: "Azure",
    input_modalities: ["text", "image", "audio"],
    output_modalities: ["audio", "text"],
  },
  {
    ...
    description: "Claude 3.7 Thinking",
    handler: generateTextPortkey,
    //    details:  "Specialized for step-by-step reasoning and detailed thinking processes.",
    reasoning: true,
    provider: "OpenRouter",
    input_modalities: ["text"],
    output_modalities: ["text"],
