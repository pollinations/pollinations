...
async function testStreamingCache() {
  ...
  const response2 = await fetch("http://localhost:8888/v1/chat/completions", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "text/event-stream",
    ...
    body: JSON.stringify({
      ...
      messages: [
        ...
        },
        {
          role: "user",
          content:
            "Create a simple counter button that increments when clicked",
        },
      ],
    }),
  });
