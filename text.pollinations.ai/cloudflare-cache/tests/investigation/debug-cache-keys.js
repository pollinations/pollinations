...
async function testCacheKeys() {
  ...
  if (result1.cacheType === 'miss' && result2.cacheType === 'hit' && result3.cacheType === 'hit') {
    console.log('✅ Cache is working correctly - deterministic keys!');
  } else if (result1.cacheType === result2.cacheType && result2.cacheType === result3.cacheType) {
    console.log('❌ All requests have same cache type - possible non-deterministic keys');
  } else {
