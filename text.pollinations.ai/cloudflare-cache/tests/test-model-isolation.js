...
async function runTests() {
	...
	await testRequest(
		"GPT-4 Model - AI Question",
		"gpt-4",
		"What is artificial intelligence?",
	);
	await testRequest(
		"Same content, Mistral Model",
		"mistral-small",
		"What is artificial intelligence?",
	);
	await testRequest(
		"Same content, GPT-4 again (should hit cache)",
		"gpt-4",
		"What is artificial intelligence?",
	);
	...
	await testRequest(
		"GPT-4 - Slightly Different AI Question",
		"gpt-4",
	...
	console.log(
		"- Similar content + same model: Semantic HIT (if above threshold)",
	);
