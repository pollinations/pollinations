...
const matchesFilters = (data, options = {}) => {
  ...
  if (!options.roblox) {
    ...
    const isRobloxReferrer =
      referrer && referrer.toLowerCase().includes("roblox");
    const isRobloxModel =
      parameters?.model &&
  ...
  if (options.referrer !== undefined) {
    ...
    if (
      ...
      return false;
    if (typeof options.referrer === "string" && referrer !== options.referrer)
      return false;
  }
  ...
  if (options.hasMarkdown !== undefined || options.hasHtml !== undefined) {
    ...
    const hasHtmlMatch =
      options.hasHtml === undefined || hasHtml(response) === options.hasHtml;
        ...
        if (options.jsonOutputFile) {
          ...
          const messageData = {
            ...
            metadata: {
              ...
              isRobloxReferrer:
                parameters?.referrer?.toLowerCase().includes("roblox") || false,
              isImagePollinationsReferrer:
                parameters?.isImagePollinationsReferrer || false,
            },
            stats: {
