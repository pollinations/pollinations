        ...
        try {
            ...
            if (!requestBody.max_tokens) {
                if (modelConfig && modelConfig.maxTokens) {
                    ...
                    log(
                        `Setting max_tokens to default value: ${config["max-tokens"]}`,
                    );
            ...
            samplingParams.forEach((param) => {
                if (
                    ...
                    log(
                        `Setting ${param} to model default value: ${config[param]}`,
                    );
            ...
            if (modelName === "azure-grok" && requestBody.seed !== undefined) {
                log(
                    `Setting seed to null for grok model (was: ${requestBody.seed})`,
                );
            ...
            if (allowedParams) {
                ...
                if (requestBody._additionalHeaders) {
                    filteredBody._additionalHeaders =
