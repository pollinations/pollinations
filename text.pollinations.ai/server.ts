...
// Models
import { generateText } from './generateTextOpenai'
import evilPrompt from './personas/evil'
import generateTextHuggingface from './generateTextHuggingface'
// import generateTextOptiLLM from './generateTextOptiLLM'
// import generateTextClaude from './generateTextClaude'
import { generateTextOpenRouter } from './generateTextOpenRouter'
import { generateDeepseek } from './generateDeepseek'
import { generateTextScaleway } from './generateTextScaleway'
import { generateTextCloudflare } from './generateTextCloudflare'
...
export function sendContentResponse(res: { setHeader: any, send: any }, completion: { choices: any }) {
...
function sendAsOpenAIStream(res: { setHeader: (arg0: string, arg1: string) => void, flushHeaders: () => void, write: (arg0: string) => void, end: () => void }, completion: { choices: { message: { content: any } }[] }) {
...
async function generateTextBasedOnModel(messages: Conversation, options: TextRequestData) {
