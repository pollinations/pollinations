 ...
 */
test.serial(
    "should generate text with o1-mini model using max_completion_tokens",
    async (t) => {
        ...
        try {
            ...
            if (
                ...
                log(
                    "Successfully generated response from o1-mini:",
                ...
                t.fail(
                    "API returned an error: " + JSON.stringify(response.error),
                );
            }
        } catch (error) {
            ...
            if (
                ...
                t.fail(
                    "Still getting max_tokens unsupported error: " +
                        error.message,
                );
            } else {
