...
test('should extract Azure configuration correctly', async t => {
    ...
    const { extractBaseUrl, extractResourceName, extractDeploymentName, extractApiVersion, azureConfig } = await import('../generateTextPortkey.js');
    ...
    // Check that Azure config has been populated
    t.true(typeof azureConfig === 'object');
    t.true(typeof azureConfig['gpt-4o-mini'] === 'object');
    t.true(typeof azureConfig['gpt-4o'] === 'object');
    t.true(typeof azureConfig['o1-mini'] === 'object');
});
