/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ccc20a36fc1827d58889e2a8af186c3f)
// Runtime types generated with workerd@1.20251011.0 2025-10-23 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./container");
		durableNamespaces: "TextServiceContainer";
	}
	interface Env {
		AZURE_OPENAI_NANO_ENDPOINT: string;
		AZURE_OPENAI_NANO_API_KEY: string;
		AZURE_OPENAI_NANO_5_ENDPOINT: string;
		AZURE_OPENAI_NANO_5_API_KEY: string;
		AZURE_OPENAI_ENDPOINT: string;
		AZURE_OPENAI_API_KEY: string;
		AZURE_OPENAI_GPT_5_API_KEY: string;
		AZURE_OPENAI_GPT_5_ENDPOINT: string;
		AZURE_OPENAI_41_ENDPOINT: string;
		AZURE_OPENAI_41_API_KEY: string;
		AZURE_OPENAI_AUDIO_ENDPOINT: string;
		AZURE_OPENAI_AUDIO_API_KEY: string;
		AZURE_OPENAI_ROBLOX_ENDPOINT_1: string;
		AZURE_OPENAI_ROBLOX_API_KEY_1: string;
		AZURE_OPENAI_ROBLOX_ENDPOINT_2: string;
		AZURE_OPENAI_ROBLOX_API_KEY_2: string;
		AZURE_OPENAI_ROBLOX_ENDPOINT_3: string;
		AZURE_OPENAI_ROBLOX_API_KEY_3: string;
		AZURE_OPENAI_ROBLOX_ENDPOINT_4: string;
		AZURE_OPENAI_ROBLOX_API_KEY_4: string;
		AZURE_OPENAI_MINI_ENDPOINT_1: string;
		AZURE_OPENAI_MINI_API_KEY_1: string;
		AZURE_OPENAI_MINI_ENDPOINT_2: string;
		AZURE_OPENAI_MINI_API_KEY_2: string;
		AZURE_O1MINI_ENDPOINT: string;
		AZURE_O1MINI_API_KEY: string;
		AZURE_O4MINI_ENDPOINT: string;
		AZURE_O4MINI_API_KEY: string;
		AZURE_DEEPSEEK_V3_ENDPOINT: string;
		AZURE_DEEPSEEK_V3_API_KEY: string;
		AZURE_DEEPSEEK_REASONING_ENDPOINT: string;
		AZURE_DEEPSEEK_REASONING_API_KEY: string;
		AZURE_MYCELI_DEEPSEEK_R1_ENDPOINT: string;
		AZURE_MYCELI_DEEPSEEK_R1_API_KEY: string;
		OPENAI_API_KEY: string;
		ANTHROPIC_API_KEY: string;
		AZURE_LLAMA_ENDPOINT: string;
		AZURE_LLAMA_API_KEY: string;
		OPENAI_PHI4_ENDPOINT: string;
		OPENAI_PHI4_API_KEY: string;
		OPENAI_PHI4_MINI_ENDPOINT: string;
		OPENAI_PHI4_MINI_API_KEY: string;
		AZURE_GENERAL_ENDPOINT: string;
		AZURE_GENERAL_API_KEY: string;
		AZURE_OPENAI_AUDIO_LARGE_ENDPOINT: string;
		AZURE_OPENAI_AUDIO_LARGE_API_KEY: string;
		AZURE_MYCELI_GPT5CHAT_ENDPOINT: string;
		AZURE_MYCELI_GPT5CHAT_API_KEY: string;
		AZURE_MYCELI_GPT41MINI_ENDPOINT: string;
		AZURE_MYCELI_GPT41MINI_API_KEY: string;
		AZURE_MYCELI_GPT5NANO_ENDPOINT: string;
		AZURE_MYCELI_GPT5NANO_API_KEY: string;
		AZURE_MYCELI_GPT5MINI_ENDPOINT: string;
		AZURE_MYCELI_GPT5MINI_API_KEY: string;
		BING_API_KEY: string;
		BING_API_KEY_2: string;
		HUGGINGFACE_TOKEN: string;
		GA_MEASUREMENT_ID: string;
		GA_API_SECRET: string;
		FEED_PASSWORD: string;
		POLLINATIONS_AUTH_API_KEY: string;
		POLLINATIONS_API_KEY: string;
		SCALEWAY_API_KEY: string;
		SCALEWAY_BASE_URL: string;
		SCALEWAY_MISTRAL_API_KEY: string;
		SCALEWAY_MISTRAL_BASE_URL: string;
		SCALEWAY_PIXTRAL_BASE_URL: string;
		SCALEWAY_PIXTRAL_API_KEY: string;
		SCALEWAY_AI_PROJECT_ID: string;
		AWS_BEARER_TOKEN_BEDROCK: string;
		AWS_BEARER_TOKEN_BEDROCK_FARGATE: string;
		IOINTELLIGENCE_API_KEY: string;
		ELIXPOSEARCH_ENDPOINT: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_AUTH_TOKEN: string;
		OPENROUTER_API_KEY: string;
		VAIBHAV_OPENAI_API_KEY: string;
		API_NAVY_ENDPOINT: string;
		APINAVY_API_KEY: string;
		NEBIUS_API_KEY: string;
		PORTKEY_API_KEY: string;
		PORTKEY_GATEWAY_URL: string;
		TINYBIRD_API_URL: string;
		TINYBIRD_API_KEY: string;
		CHATWITHMONO_API_KEY: string;
		GOOGLE_APPLICATION_CREDENTIALS: string;
		GCLOUD_PROJECT_ID: string;
		USER_MODEL_MAPPING: string;
		CONTAINER: DurableObjectNamespace<import("./container").TextServiceContainer>;
	}
}
